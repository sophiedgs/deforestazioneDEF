...
(() => {
	...
	var Gl = Object.getPrototypeOf, ql = Object.prototype.hasOwnProperty;
	var B = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports);
	var Nl = (t, e, i, r) => {
		if (e && typeof e == "object" || typeof e == "function") for (let n of Al(e)) !ql.call(t, n) && n !== i && Yi(t, n, {
			get: () => e[n],
			enumerable: !(r = Il(e, n)) || r.enumerable
		});
		return t;
	};
	var wt = (t, e, i) => (i = t != null ? Ol(Gl(t)) : {}, Nl(e || !t || !t.__esModule ? Yi(i, "default", {
		value: t,
		enumerable: !0
	}) : i, t));
	var Zi = B((d_, $i) => {
	...
	var ae = B((m_, Qi) => {
		var Vl = se();
		function Ul(t, e) {
			for (var i = t.length; i--;) if (Vl(t[i][0], e)) return i;
			return -1;
		}
		Qi.exports = Ul;
	});
	var er = B((__, tr) => {
		var Kl = ae(), Xl = Array.prototype.splice;
		function Yl(t) {
			var e = this.__data__, i = Kl(e, t);
			if (i < 0) return !1;
			return i == e.length - 1 ? e.pop() : Xl.call(e, i, 1), --this.size, !0;
		}
		tr.exports = Yl;
	});
	var rr = B((y_, ir) => {
	...
	var or = B((b_, ar) => {
		var Ql = ae();
		function th(t, e) {
			var i = this.__data__, r = Ql(i, t);
			return r < 0 ? (++this.size, i.push([t, e])) : i[r][1] = e, this;
		}
		ar.exports = th;
	});
	var oe = B((k_, lr) => {
		var eh = Zi(), ih = er(), rh = rr(), nh = sr(), sh = or();
		function jt(t) {
		...
		jt.prototype.clear = eh;
		jt.prototype.delete = ih;
		jt.prototype.get = rh;
		jt.prototype.has = nh;
		jt.prototype.set = sh;
		lr.exports = jt;
	...
	var cr = B((M_, hr) => {
		var ah = oe();
		function oh() {
			this.__data__ = new ah(), this.size = 0;
		}
		hr.exports = oh;
	});
	var pr = B((v_, ur) => {
	...
	var ti = B((C_, _r) => {
		_r.exports = typeof global == "object" && global && global.Object === Object && global;
	});
	var It = B((E_, yr) => {
		var ph = ti(), fh = typeof self == "object" && self && self.Object === Object && self;
		yr.exports = ph || fh || Function("return this")();
	});
	var Se = B((P_, Lr) => {
		Lr.exports = It().Symbol;
	});
	var vr = B((S_, Mr) => {
		var br = Se(), kr = Object.prototype, _h = kr.hasOwnProperty, yh = kr.toString, le = br ? br.toStringTag : void 0;
		function Lh(t) {
			var e = _h.call(t, le), i = t[le];
			try {
				t[le] = void 0;
				var r = !0;
			} catch {}
	...
	var Vt = B((B_, Pr) => {
		var Cr = Se(), vh = vr(), xh = wr(), wh = "[object Null]", Ch = "[object Undefined]", Er = Cr ? Cr.toStringTag : void 0;
		function Eh(t) {
			return t == null ? t === void 0 ? Ch : wh : Er && Er in Object(t) ? vh(t) : xh(t);
		}
		Pr.exports = Eh;
	});
	var Ct = B((D_, Sr) => {
	...
	var Te = B((R_, Tr) => {
		var Sh = Vt(), Th = Ct(), Bh = "[object AsyncFunction]", Dh = "[object Function]", Rh = "[object GeneratorFunction]", Oh = "[object Proxy]";
		function Ih(t) {
			if (!Th(t)) return !1;
			var e = Sh(t);
			return e == Dh || e == Rh || e == Bh || e == Oh;
		}
		Tr.exports = Ih;
	});
	var Dr = B((O_, Br) => {
		Br.exports = It()["__core-js_shared__"];
	});
	var Ir = B((I_, Or) => {
		var ei = Dr(), Rr = (function() {
	...
	var Gr = B((A_, Ar) => {
		var zh = Function.prototype.toString;
		function Fh(t) {
			if (t != null) {
				try {
					return zh.call(t);
	...
	var Nr = B((G_, qr) => {
		var jh = Te(), Vh = Ir(), Uh = Ct(), Kh = Gr(), Hh = /[\\^$.*+?()[\]{}|]/g, Xh = /^\[object .+?Constructor\]$/, Yh = Function.prototype, Jh = Object.prototype, $h = Yh.toString, Zh = Jh.hasOwnProperty, Wh = RegExp("^" + $h.call(Zh).replace(Hh, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
		function Qh(t) {
			if (!Uh(t) || Vh(t)) return !1;
			return (jh(t) ? Wh : Xh).test(Kh(t));
		}
		qr.exports = Qh;
	});
	var Fr = B((q_, zr) => {
	...
	var Be = B((N_, jr) => {
		...
		function rc(t, e) {
			var i = ic(t, e);
			return ec(i) ? i : void 0;
		}
		jr.exports = rc;
	});
	var ii = B((z_, Vr) => {
		Vr.exports = Be()(It(), "Map");
	});
	var he = B((F_, Ur) => {
		Ur.exports = Be()(Object, "create");
	});
	var Xr = B((j_, Hr) => {
		var Kr = he();
		function hc() {
	...
	var Zr = B((U_, $r) => {
		var uc = he(), pc = "__lodash_hash_undefined__", dc = Object.prototype.hasOwnProperty;
		function gc(t) {
			var e = this.__data__;
			if (uc) {
				var i = e[t];
				return i === pc ? void 0 : i;
			}
	...
	var Qr = B((K_, Wr) => {
		var mc = he(), yc = Object.prototype.hasOwnProperty;
		function Lc(t) {
			var e = this.__data__;
			return mc ? e[t] !== void 0 : yc.call(e, t);
		}
		Wr.exports = Lc;
	});
	var en = B((H_, tn) => {
		var bc = he(), kc = "__lodash_hash_undefined__";
		function Mc(t, e) {
			var i = this.__data__;
			return this.size += this.has(t) ? 0 : 1, i[t] = bc && e === void 0 ? kc : e, this;
		}
		tn.exports = Mc;
	});
	var nn = B((X_, rn) => {
		var vc = Xr(), xc = Jr(), wc = Zr(), Cc = Qr(), Ec = en();
		function Ut(t) {
			var e = -1, i = t == null ? 0 : t.length;
			for (this.clear(); ++e < i;) {
				var r = t[e];
	...
	var ce = B(($_, cn) => {
		...
		function Rc(t, e) {
			var i = t.__data__;
			return Dc(e) ? i[typeof e == "string" ? "string" : "hash"] : i.map;
		}
		cn.exports = Rc;
	});
	var pn = B((Z_, un) => {
	...
	var yn = B((ty, _n) => {
		var zc = ce();
		function Fc(t, e) {
			var i = zc(this, t), r = i.size;
			return i.set(t, e), this.size += i.size == r ? 0 : 1, this;
		}
		_n.exports = Fc;
	});
	var ri = B((ey, Ln) => {
		var jc = on(), Vc = pn(), Uc = dn(), Kc = mn(), Hc = yn();
		function Kt(t) {
			var e = -1, i = t == null ? 0 : t.length;
			for (this.clear(); ++e < i;) {
				var r = t[e];
	...
	var kn = B((iy, bn) => {
		var Xc = oe(), Yc = ii(), Jc = ri(), $c = 200;
		function Zc(t, e) {
			var i = this.__data__;
			if (i instanceof Xc) {
				var r = i.__data__;
				if (!Yc || r.length < $c - 1) return r.push([t, e]), this.size = ++i.size, this;
				i = this.__data__ = new Jc(r);
			}
	...
	var vn = B((ry, Mn) => {
		var Wc = oe(), Qc = cr(), tu = pr(), eu = dr(), iu = mr(), ru = kn();
		function Ht(t) {
			this.size = (this.__data__ = new Wc(t)).size;
		}
		Ht.prototype.clear = Qc;
		Ht.prototype.delete = tu;
		Ht.prototype.get = eu;
		Ht.prototype.has = iu;
		Ht.prototype.set = ru;
		Mn.exports = Ht;
	...
	var si = B((ay, En) => {
		var ou = De(), lu = se();
		function hu(t, e, i) {
			(i !== void 0 && !lu(t[e], i) || i === void 0 && !(e in t)) && ou(t, e, i);
		}
		En.exports = hu;
	});
	var Sn = B((oy, Pn) => {
	...
	var An = B((ue, Xt) => {
		var fu = It(), In = typeof ue == "object" && ue && !ue.nodeType && ue, Dn = In && typeof Xt == "object" && Xt && !Xt.nodeType && Xt, Rn = Dn && Dn.exports === In ? fu.Buffer : void 0, On = Rn ? Rn.allocUnsafe : void 0;
		function gu(t, e) {
			if (e) return t.slice();
			var i = t.length, r = On ? On(i) : new t.constructor(i);
			return t.copy(r), r;
		}
		Xt.exports = gu;
	});
	var qn = B((hy, Gn) => {
		Gn.exports = It().Uint8Array;
	});
	var Fn = B((cy, zn) => {
		var Nn = qn();
		function yu(t) {
	...
	var ai = B((gy, Zn) => {
		Zn.exports = $n()(Object.getPrototypeOf, Object);
	});
	var oi = B((my, Wn) => {
		var Eu = Object.prototype;
		function Pu(t) {
			var e = t && t.constructor;
			return t === (typeof e == "function" && e.prototype || Eu);
		}
		Wn.exports = Pu;
	});
	var ts = B((_y, Qn) => {
		var Su = Yn(), Tu = ai(), Bu = oi();
		function Du(t) {
			return typeof t.constructor == "function" && !Bu(t) ? Su(Tu(t)) : {};
		}
		Qn.exports = Du;
	});
	var At = B((yy, es) => {
	...
	var rs = B((Ly, is) => {
		var Ou = Vt(), Iu = At(), Au = "[object Arguments]";
		function Gu(t) {
			return Iu(t) && Ou(t) == Au;
		}
		is.exports = Gu;
	...
	var li = B((by, as) => {
		var ns = rs(), qu = At(), ss = Object.prototype, Nu = ss.hasOwnProperty, zu = ss.propertyIsEnumerable;
		as.exports = ns((function() {
			return arguments;
		})()) ? ns : function(t) {
			return qu(t) && Nu.call(t, "callee") && !zu.call(t, "callee");
		};
	});
	var Yt = B((ky, os) => {
		os.exports = Array.isArray;
	});
	var hi = B((My, ls) => {
	...
	var Re = B((vy, hs) => {
		var Ku = Te(), Hu = hi();
		function Xu(t) {
			return t != null && Hu(t.length) && !Ku(t);
		}
		hs.exports = Xu;
	});
	var us = B((xy, cs) => {
	...
	var ci = B((pe, Jt) => {
		var Wu = It(), Qu = fs(), ms = typeof pe == "object" && pe && !pe.nodeType && pe, ds = ms && typeof Jt == "object" && Jt && !Jt.nodeType && Jt, gs = ds && ds.exports === ms ? Wu.Buffer : void 0;
		Jt.exports = (gs ? gs.isBuffer : void 0) || Qu;
	});
	var Ls = B((Cy, ys) => {
		var rp = Vt(), np = ai(), sp = At(), ap = "[object Object]", op = Function.prototype, lp = Object.prototype, _s = op.toString, hp = lp.hasOwnProperty, cp = _s.call(Object);
		function up(t) {
			if (!sp(t) || rp(t) != ap) return !1;
			var e = np(t);
			if (e === null) return !0;
			var i = hp.call(e, "constructor") && e.constructor;
			return typeof i == "function" && i instanceof i && _s.call(i) == cp;
		}
		ys.exports = up;
	});
	var ks = B((Ey, bs) => {
		...
		J[Tp] = J[Bp] = J[Dp] = J[Rp] = J[Op] = J[Ip] = J[Ap] = J[Gp] = J[qp] = !0;
		J[gp] = J[mp] = J[Pp] = J[_p] = J[Sp] = J[yp] = J[Lp] = J[bp] = J[kp] = J[Mp] = J[vp] = J[xp] = J[wp] = J[Cp] = J[Ep] = !1;
		function Np(t) {
			return dp(t) && fp(t.length) && !!J[pp(t)];
		}
		bs.exports = Np;
	});
	var vs = B((Py, Ms) => {
	...
	var ws = B((fe, $t) => {
		var Fp = ti(), xs = typeof fe == "object" && fe && !fe.nodeType && fe, de = xs && typeof $t == "object" && $t && !$t.nodeType && $t, ui = de && de.exports === xs && Fp.process;
		$t.exports = (function() {
			try {
				return de && de.require && de.require("util").types || ui && ui.binding && ui.binding("util");
			} catch {}
		})();
	});
	var pi = B((Sy, Ps) => {
		var Up = ks(), Kp = vs(), Cs = ws(), Es = Cs && Cs.isTypedArray;
		Ps.exports = Es ? Kp(Es) : Up;
	});
	var fi = B((Ty, Ss) => {
		function Xp(t, e) {
	...
	var Bs = B((By, Ts) => {
		var Yp = De(), Jp = se(), Zp = Object.prototype.hasOwnProperty;
		function Wp(t, e, i) {
			var r = t[e];
			(!(Zp.call(t, e) && Jp(r, i)) || i === void 0 && !(e in t)) && Yp(t, e, i);
		}
		Ts.exports = Wp;
	});
	var Rs = B((Dy, Ds) => {
		...
		function ef(t, e, i, r) {
			...
			for (var s = -1, a = e.length; ++s < a;) {
				var o = e[s], h = r ? r(i[o], t[o], o, i, t) : void 0;
				h === void 0 && (h = t[o]), n ? tf(i, o, h) : Qp(i, o, h);
			}
			return i;
		}
		Ds.exports = ef;
	...
	var di = B((Oy, As) => {
		var nf = 9007199254740991, sf = /^(?:0|[1-9]\d*)$/;
		function af(t, e) {
			var i = typeof t;
			return e = e ?? nf, !!e && (i == "number" || i != "symbol" && sf.test(t)) && t > -1 && t % 1 == 0 && t < e;
		}
		As.exports = af;
	});
	var qs = B((Iy, Gs) => {
		var of = Is(), lf = li(), hf = Yt(), cf = ci(), uf = di(), pf = pi(), df = Object.prototype.hasOwnProperty;
		function gf(t, e) {
			var i = hf(t), r = !i && lf(t), n = !i && !r && cf(t), s = !i && !r && !n && pf(t), a = i || r || n || s, o = a ? of(t.length, String) : [], h = o.length;
			for (var l in t) (e || df.call(t, l)) && !(a && (l == "length" || n && (l == "offset" || l == "parent") || s && (l == "buffer" || l == "byteLength" || l == "byteOffset") || uf(l, h))) && o.push(l);
			return o;
		}
		Gs.exports = gf;
	});
	...
	var js = B((Gy, Fs) => {
		var _f = Ct(), yf = oi(), Lf = zs(), kf = Object.prototype.hasOwnProperty;
		function Mf(t) {
			if (!_f(t)) return Lf(t);
			var e = yf(t), i = [];
			for (var r in t) r == "constructor" && (e || !kf.call(t, r)) || i.push(r);
			return i;
		}
		Fs.exports = Mf;
	});
	var gi = B((qy, Vs) => {
		var vf = qs(), xf = js(), wf = Re();
		function Cf(t) {
			return wf(t) ? vf(t, !0) : xf(t);
		}
		Vs.exports = Cf;
	});
	var Ks = B((Ny, Us) => {
	...
	var Zs = B((zy, $s) => {
		var Hs = si(), Tf = An(), Bf = Vn(), Df = Kn(), Rf = ts(), Xs = li(), Ys = Yt(), Of = us(), If = ci(), Af = Te(), Gf = Ct(), qf = Ls(), Nf = pi(), Js = fi(), zf = Ks();
		function Ff(t, e, i, r, n, s, a) {
			var o = Js(t, i), h = Js(e, i), l = a.get(h);
			if (l) {
				Hs(t, i, l);
				return;
			}
			var d = s ? s(o, h, i + "", t, e, a) : void 0, f = d === void 0;
			if (f) {
				var k = Ys(h), w = !k && If(h), S = !k && !w && Nf(h);
				d = h, k || w || S ? Ys(o) ? d = o : Of(o) ? d = Df(o) : w ? (f = !1, d = Tf(h, !0)) : S ? (f = !1, d = Bf(h, !0)) : d = [] : qf(h) || Xs(h) ? (d = o, Xs(o) ? d = zf(o) : (!Gf(o) || Af(o)) && (d = Rf(h))) : f = !1;
			}
			f && (a.set(h, d), n(d, h, r, s, a), a.delete(h)), Hs(t, i, d);
		}
		$s.exports = Ff;
	});
	var ta = B((Fy, Qs) => {
		var jf = vn(), Vf = si(), Uf = Bn(), Kf = Zs(), Hf = Ct(), Xf = gi(), Yf = fi();
		function Ws(t, e, i, r, n) {
			t !== e && Uf(e, function(s, a) {
				if (n || (n = new jf()), Hf(s)) Kf(t, e, a, i, Ws, r, n);
				else {
					var o = r ? r(Yf(t, a), s, a + "", t, e, n) : void 0;
					o === void 0 && (o = s), Vf(t, a, o);
				}
			}, Xf);
		}
		Qs.exports = Ws;
	...
	var ra = B((Vy, ia) => {
		function $f(t, e, i) {
			switch (i.length) {
				...
				case 1: return t.call(e, i[0]);
				case 2: return t.call(e, i[0], i[1]);
				case 3: return t.call(e, i[0], i[1], i[2]);
			}
			return t.apply(e, i);
		}
		ia.exports = $f;
	...
	var aa = B((Uy, sa) => {
		var Zf = ra(), na = Math.max;
		function Wf(t, e, i) {
			return e = na(e === void 0 ? t.length - 1 : e, 0), function() {
				for (var r = arguments, n = -1, s = na(r.length - e, 0), a = Array(s); ++n < s;) a[n] = r[e + n];
				n = -1;
				for (var o = Array(e + 1); ++n < e;) o[n] = r[n];
				return o[e] = i(a), Zf(t, this, o);
			};
		}
		sa.exports = Wf;
	});
	...
	var ua = B((Hy, ca) => {
		var td = la(), ha = ni(), ed = mi();
		ca.exports = ha ? function(t, e) {
	...
	var fa = B((Xy, pa) => {
		var rd = 800, nd = 16, sd = Date.now;
		function ad(t) {
			var e = 0, i = 0;
			return function() {
				var r = sd(), n = nd - (r - i);
				if (i = r, n > 0) {
					if (++e >= rd) return arguments[0];
				} else e = 0;
	...
	var _a = B((Jy, ma) => {
		var cd = mi(), ud = aa(), pd = ga();
		function fd(t, e) {
			return pd(ud(t, e, cd), t + "");
		}
		ma.exports = fd;
	});
	var La = B(($y, ya) => {
		var dd = se(), gd = Re(), md = di(), _d = Ct();
		function yd(t, e, i) {
			if (!_d(i)) return !1;
			var r = typeof e;
			return (r == "number" ? gd(i) && md(e, i.length) : r == "string" && e in i) ? dd(i[e], t) : !1;
		}
		ya.exports = yd;
	});
	var ka = B((Zy, ba) => {
		var Ld = _a(), bd = La();
		function kd(t) {
			return Ld(function(e, i) {
				var r = -1, n = i.length, s = n > 1 ? i[n - 1] : void 0, a = n > 2 ? i[2] : void 0;
				for (s = t.length > 3 && typeof s == "function" ? (n--, s) : void 0, a && bd(i[0], i[1], a) && (s = n < 3 ? void 0 : s, n = 1), e = Object(e); ++r < n;) {
					var o = i[r];
					o && t(e, o, r, s);
				}
				return e;
	...
	var Oe = B((Wy, Ma) => {
		var Md = ta();
		Ma.exports = ka()(function(t, e, i) {
			Md(t, e, i);
		});
	});
	var Ie = B((ab, eo) => {
		var sg = Vt(), ag = At(), og = "[object Symbol]";
		function lg(t) {
			return typeof t == "symbol" || ag(t) && sg(t) == og;
		}
		eo.exports = lg;
	});
	var ro = B((ob, io) => {
		var hg = Yt(), cg = Ie(), ug = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, pg = /^\w*$/;
		function fg(t, e) {
			if (hg(t)) return !1;
			var i = typeof t;
			return i == "number" || i == "symbol" || i == "boolean" || t == null || cg(t) ? !0 : pg.test(t) || !ug.test(t) || e != null && t in Object(e);
		}
		io.exports = fg;
	});
	var ao = B((lb, so) => {
		var no = ri(), dg = "Expected a function";
		function yi(t, e) {
			if (typeof t != "function" || e != null && typeof e != "function") throw new TypeError(dg);
			var i = function() {
			...
			return i.cache = new (yi.Cache || no)(), i;
		}
		yi.Cache = no;
		so.exports = yi;
	});
	...
	var co = B((cb, ho) => {
		var yg = lo(), Lg = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, bg = /\\(\\)?/g;
		ho.exports = yg(function(t) {
			var e = [];
			return t.charCodeAt(0) === 46 && e.push(""), t.replace(Lg, function(i, r, n, s) {
				e.push(n ? s.replace(bg, "$1") : r || i);
			}), e;
		});
	});
	var po = B((ub, uo) => {
	...
	var Lo = B((pb, yo) => {
		var fo = Se(), vg = po(), xg = Yt(), wg = Ie(), Cg = Infinity, go = fo ? fo.prototype : void 0, mo = go ? go.toString : void 0;
		function _o(t) {
			if (typeof t == "string") return t;
			if (xg(t)) return vg(t, _o) + "";
			if (wg(t)) return mo ? mo.call(t) : "";
			var e = t + "";
			return e == "0" && 1 / t == -Cg ? "-0" : e;
		}
		yo.exports = _o;
	});
	var ko = B((fb, bo) => {
	...
	var vo = B((db, Mo) => {
		var Sg = Yt(), Tg = ro(), Bg = co(), Dg = ko();
		function Rg(t, e) {
			return Sg(t) ? t : Tg(t, e) ? [t] : Bg(Dg(t));
		}
		Mo.exports = Rg;
	});
	var wo = B((gb, xo) => {
		var Og = Ie(), Ig = Infinity;
		function Ag(t) {
			if (typeof t == "string" || Og(t)) return t;
			var e = t + "";
			return e == "0" && 1 / t == -Ig ? "-0" : e;
		}
		xo.exports = Ag;
	});
	var Eo = B((mb, Co) => {
		...
		function Ng(t, e) {
			e = Gg(e, t);
			for (var i = 0, r = e.length; t != null && i < r;) t = t[qg(e[i++])];
	...
	var Fo = B((Ei, Pi) => {
		(function(t, e) {
			typeof Ei == "object" && typeof Pi < "u" ? Pi.exports = e() : typeof define == "function" && define.amd ? define(e) : (t = t || self).RBush = e();
		})(Ei, function() {
			"use strict";
			function t(g, M, m, O, R) {
				(function I(G, q, c, u, p) {
					for (; u > c;) {
						if (u - c > 600) {
							var y = u - c + 1, _ = q - c + 1, v = Math.log(y), E = .5 * Math.exp(2 * v / 3), b = .5 * Math.sqrt(v * E * (y - E) / y) * (_ - y / 2 < 0 ? -1 : 1);
							I(G, q, Math.max(c, Math.floor(q - _ * E / y + b)), Math.min(u, Math.floor(q + (y - _) * E / y + b)), p);
						}
						var C = G[q], T = c, N = u;
						for (e(G, c, q), p(G[u], C) > 0 && e(G, c, u); T < N;) {
							for (e(G, T, N), T++, N--; p(G[T], C) < 0;) T++;
							for (; p(G[N], C) > 0;) N--;
						}
						p(G[c], C) === 0 ? e(G, c, N) : e(G, ++N, u), N <= q && (c = N + 1), q <= N && (u = N - 1);
					}
				})(g, M, m || 0, O || g.length - 1, R || i);
			}
			function e(g, M, m) {
				var O = g[M];
				g[M] = g[m], g[m] = O;
			...
			var r = function(g) {
				g === void 0 && (g = 9), this._maxEntries = Math.max(4, g), this._minEntries = Math.max(2, Math.ceil(.4 * this._maxEntries)), this.clear();
			};
			function n(g, M, m) {
				if (!m) return M.indexOf(g);
				for (var O = 0; O < M.length; O++) if (m(g, M[O])) return O;
				return -1;
			}
			function s(g, M) {
				a(g, 0, g.children.length, M, g);
			}
			function a(g, M, m, O, R) {
				R || (R = S(null)), R.minX = Infinity, R.minY = Infinity, R.maxX = -Infinity, R.maxY = -Infinity;
				for (var I = M; I < m; I++) {
					var G = g.children[I];
					o(R, g.leaf ? O(G) : G);
				}
			...
			function A(g, M, m, O, R) {
				for (var I = [M, m]; I.length;) if (!((m = I.pop()) - (M = I.pop()) <= O)) {
					var G = M + Math.ceil((m - M) / O / 2) * O;
					t(g, G, M, m, R), I.push(M, G, G, m);
				}
			}
			return r.prototype.all = function() {
				...
				for (var O = this.toBBox, R = []; M;) {
					for (var I = 0; I < M.children.length; I++) {
						...
						w(g, q) && (M.leaf ? m.push(G) : k(g, q) ? this._all(G, m) : R.push(G));
					}
					M = R.pop();
				}
				return m;
				...
				var m = this._build(g.slice(), 0, g.length - 1, 0);
				if (this.data.children.length) if (this.data.height === m.height) this._splitRoot(this.data, m);
				else {
				...
				if (!g) return this;
				for (var m, O, R, I = this.data, G = this.toBBox(g), q = [], c = []; I || q.length;) {
					if (I || (I = q.pop(), O = q[q.length - 1], m = c.pop(), R = !0), I.leaf) {
						var u = n(g, I.children, M);
						if (u !== -1) return I.children.splice(u, 1), q.push(I), this._condense(q), this;
					}
					R || I.leaf || !k(I, G) ? O ? (m++, I = O.children[m], R = !1) : I = null : (q.push(I), c.push(m), m = 0, O = I, I = I.children[0]);
				}
				return this;
				...
				for (var m = []; g;) g.leaf ? M.push.apply(M, g.children) : m.push.apply(m, g.children), g = m.pop();
				return M;
			}, r.prototype._build = function(g, M, m, O) {
				var R, I = m - M + 1, G = this._maxEntries;
				if (I <= G) return s(R = S(g.slice(M, m + 1)), this.toBBox), R;
				O || (O = Math.ceil(Math.log(I) / Math.log(G)), G = Math.ceil(I / Math.pow(G, O - 1))), (R = S([])).leaf = !1, R.height = O;
				var q = Math.ceil(I / G), c = q * Math.ceil(Math.sqrt(G));
				A(g, M, m, c, this.compareMinX);
				for (var u = M; u <= m; u += c) {
					var p = Math.min(u + c - 1, m);
					A(g, u, p, q, this.compareMinY);
					for (var y = u; y <= p; y += q) {
						var _ = Math.min(y + q - 1, p);
						R.children.push(this._build(g, y, _, O - 1));
					}
				}
				return s(R, this.toBBox), R;
			}, r.prototype._chooseSubtree = function(g, M, m, O) {
				for (; O.push(M), !M.leaf && O.length - 1 !== m;) {
					for (var R = Infinity, I = Infinity, G = void 0, q = 0; q < M.children.length; q++) {
						var c = M.children[q], u = d(c), p = (y = g, _ = c, (Math.max(_.maxX, y.maxX) - Math.min(_.minX, y.minX)) * (Math.max(_.maxY, y.maxY) - Math.min(_.minY, y.minY)) - u);
						p < I ? (I = p, R = u < R ? u : R, G = c) : p === I && u < R && (R = u, G = c);
					}
					M = G || M.children[0];
				}
				var y, _;
				return M;
			}, r.prototype._insert = function(g, M, m) {
				var O = m ? g : this.toBBox(g), R = [], I = this._chooseSubtree(O, this.data, M, R);
				for (I.children.push(g), o(I, O); M >= 0 && R[M].children.length > this._maxEntries;) this._split(R, M), M--;
				this._adjustParentBBoxes(O, R, M);
			}, r.prototype._split = function(g, M) {
				var m = g[M], O = m.children.length, R = this._minEntries;
				this._chooseSplitAxis(m, R, O);
				var I = this._chooseSplitIndex(m, R, O), G = S(m.children.splice(I, m.children.length - I));
				G.height = m.height, G.leaf = m.leaf, s(m, this.toBBox), s(G, this.toBBox), M ? g[M - 1].children.push(G) : this._splitRoot(m, G);
			}, r.prototype._splitRoot = function(g, M) {
				this.data = S([g, M]), this.data.height = g.height + 1, this.data.leaf = !1, s(this.data, this.toBBox);
			}, r.prototype._chooseSplitIndex = function(g, M, m) {
				for (var O, R, I, G, q, c, u, p = Infinity, y = Infinity, _ = M; _ <= m - M; _++) {
					var v = a(g, 0, _, this.toBBox), E = a(g, _, m, this.toBBox), b = (R = v, I = E, G = void 0, q = void 0, c = void 0, u = void 0, G = Math.max(R.minX, I.minX), q = Math.max(R.minY, I.minY), c = Math.min(R.maxX, I.maxX), u = Math.min(R.maxY, I.maxY), Math.max(0, c - G) * Math.max(0, u - q)), x = d(v) + d(E);
					b < p ? (p = b, O = _, y = x < y ? x : y) : b === p && x < y && (y = x, O = _);
				}
				return O || m - M;
			}, r.prototype._chooseSplitAxis = function(g, M, m) {
				var O = g.leaf ? this.compareMinX : h, R = g.leaf ? this.compareMinY : l;
				this._allDistMargin(g, M, m, O) < this._allDistMargin(g, M, m, R) && g.children.sort(O);
			}, r.prototype._allDistMargin = function(g, M, m, O) {
				g.children.sort(O);
				for (var R = this.toBBox, I = a(g, 0, M, R), G = a(g, m - M, m, R), q = f(I) + f(G), c = M; c < m - M; c++) {
					var u = g.children[c];
					o(I, g.leaf ? R(u) : u), q += f(I);
				}
				for (var p = m - M - 1; p >= M; p--) {
					var y = g.children[p];
					o(G, g.leaf ? R(y) : y), q += f(G);
				}
				return q;
			}, r.prototype._adjustParentBBoxes = function(g, M, m) {
				for (var O = m; O >= 0; O--) o(M[O], g);
			}, r.prototype._condense = function(g) {
				for (var M = g.length - 1, m = void 0; M >= 0; M--) g[M].children.length === 0 ? M > 0 ? (m = g[M - 1].children).splice(m.indexOf(g[M]), 1) : this.clear() : s(g[M], this.toBBox);
			}, r;
		});
	});
	...
	Array.prototype.includes || Object.defineProperty(Array.prototype, "includes", { value: function(t, e) {
		...
		function a(o, h) {
			return o === h || typeof o == "number" && typeof h == "number" && isNaN(o) && isNaN(h);
		}
		for (; s < r;) {
			if (a(i[s], t)) return !0;
			s++;
	...
	var Qa = wt(Oe()), Pt = {
		...
		__fire(t, e, i, r, n = {}) {
			i = (0, Qa.default)(i, n, { source: r }), L.PM.Utils._fireEvent(t, e, i);
		}
	};
	var ng = () => ({
		_lastEvents: {
		...
		_handleEnterKey(t) {
			...
			if (!r) return !1;
			let n = e.Draw[r];
			return !n || !n._finishShape || !this._canFinishShape(n, r) ? !1 : (t.preventDefault(), n._finishShape(), !0);
		},
		_canFinishShape(t, e) {
			if ([
				"Marker",
			...
			if (e === "Circle") return t._centerMarker && t._layerGroup?.hasLayer(t._centerMarker);
	...
	function F(t) {
		...
		return (0, Li.default)(Et[e], t) || (0, Li.default)(Et.en, t) || t;
	}
	function So() {
	...
	function jg(t, e, i) {
		...
		}, o = t.lng, h = t.lat, l = i, d = Math.PI, f = e * d / 180, k = Math.sin(f), w = Math.cos(f), S = (1 - a) * Math.tan(h * d / 180), A = 1 / Math.sqrt(1 + S * S), g = S * A, M = Math.atan2(S, w), m = A * k, O = 1 - m * m, R = O * (n * n - s * s) / (s * s), I = 1 + R / 16384 * (4096 + R * (-768 + R * (320 - 175 * R))), G = R / 1024 * (256 + R * (-128 + R * (74 - 47 * R))), q = l / (s * I), c = 2 * Math.PI, u, p, y;
		for (; Math.abs(q - c) > 1e-12;) {
			u = Math.cos(2 * M + q), p = Math.sin(q), y = Math.cos(q);
			let T = G * p * (u + G / 4 * (y * (-1 + 2 * u * u) - G / 6 * u * (-3 + 4 * p * p) * (-3 + 4 * u * u)));
			c = q, q = l / (s * I) + T;
		}
		let _ = g * p - A * y * w, v = Math.atan2(g * y + A * p * w, (1 - a) * Math.sqrt(m * m + _ * _)), E = Math.atan2(p * k, A * y - g * p * w), b = a / 16 * O * (4 + a * (4 - 3 * O)), P = o + (E - (1 - b) * a * m * (q + b * p * (u + b * y * (-1 + 2 * u * u)))) * 180 / d, C = v * 180 / d;
		return L.latLng(P, C);
	}
	function bi(t, e, i, r, n = !0) {
		let s, a, o, h = [];
		for (let l = 0; l < i; l += 1) {
			if (n) s = l * 360 / i + r, a = jg(t, s, e), o = L.latLng(a.lng, a.lat);
			else {
	...
	function Vg(t, e, i) {
		e = (e + 360) % 360;
		let r = Math.PI / 180, n = 180 / Math.PI, { R: s } = L.CRS.Earth, a = t.lng * r, o = t.lat * r, h = e * r, l = Math.sin(o), d = Math.cos(o), f = Math.cos(i / s), k = Math.sin(i / s), w = Math.asin(l * f + d * k * Math.cos(h)), S = a + Math.atan2(Math.sin(h) * k * d, f - l * Math.sin(w));
		S *= n;
	...
	function Zt(t, e, i, r) {
		return Vg(e, ye(t, e, i), r);
	}
	function To(t, e, i = "asc") {
		if (!e || Object.keys(e).length === 0) return (h, l) => h - l;
		let r = Object.keys(e), n, s = r.length - 1, a = {};
		for (; s >= 0;) n = r[s], a[n.toLowerCase()] = e[n], s -= 1;
		function o(h) {
			if (h instanceof L.Marker) return "Marker";
			if (h instanceof L.Circle) return "Circle";
			if (h instanceof L.CircleMarker) return "CircleMarker";
			if (h instanceof L.Rectangle) return "Rectangle";
			if (h instanceof L.Polygon) return "Polygon";
			if (h instanceof L.Polyline) return "Line";
		}
		return (h, l) => {
			let d, f;
			if (t === "instanceofShape") {
				if (d = o(h.layer).toLowerCase(), f = o(l.layer).toLowerCase(), !d || !f) return 0;
			} else {
				if (!h.hasOwnProperty(t) || !l.hasOwnProperty(t)) return 0;
				d = h[t].toLowerCase(), f = l[t].toLowerCase();
			}
			let k = d in a ? a[d] : Number.MAX_SAFE_INTEGER, w = f in a ? a[f] : Number.MAX_SAFE_INTEGER, S = 0;
	...
	var Do = L.Class.extend({
		...
		initialize(t) {
			this.map = t, this.Draw = new L.PM.Draw(t), this.Toolbar = new L.PM.Toolbar(t), this.Keyboard = to(), this.globalOptions = {
				snappable: !0,
				layerGroup: void 0,
				snappingOrder: [
					"Marker",
		...
		setLang(t = "en", e, i = "en") {
			...
			e && (Et[t] = (0, Mi.default)(Et[i], e)), L.PM.activeLang = t, this.map.pm.Toolbar.reinit(), this._fireLangChange(r, t, i, Et[t]);
		},
		addControls(t) {
		...
		setPathOptions(t, e = {}) {
			let i = e.ignoreShapes || [], r = e.merge || !1;
		...
		setGlobalOptions(t) {
			let e = (0, Mi.default)(this.globalOptions, t);
			...
			let r = !1;
			this.map.pm.Draw.Circle.enabled() && !!this.map.pm.Draw.Circle.options.resizeableCircle != !!e.resizeableCircle && (this.map.pm.Draw.Circle.disable(), r = !0), this.map.pm.Draw.shapes.forEach((s) => {
	...
	var Ro = L.Control.extend({
		...
		_makeButton(t) {
			...
			let n = L.DomUtil.create("div", `leaflet-pm-actions-container ${e}`, i), s = t.actions, a = {
				cancel: {
					text: F("actions.cancel"),
					title: F("actions.cancel"),
					onClick() {
						this._triggerClick();
					}
				},
				finishMode: {
					text: F("actions.finish"),
					title: F("actions.finish"),
					onClick() {
						this._triggerClick();
					}
				},
				removeLastVertex: {
					text: F("actions.removeLastVertex"),
					title: F("actions.removeLastVertex"),
					onClick() {
				...
				finish: {
					...
					title: F("actions.finish"),
					onClick(h) {
						this._map.pm.Draw[t.jsClass]._finishShape(h);
					}
				}
			};
			t._preparedActions = s.map((h) => {
				let l = typeof h == "string" ? h : h.name, d;
				if (a[l]) d = a[l];
				else if (h.text) d = h;
				else return d;
		...
		_updateActiveAction(t) {
			t._preparedActions?.forEach((e) => {
				e?._node && (e.isActive && e.isActive.call(this) ? L.DomUtil.addClass(e._node, "active-action") : L.DomUtil.removeClass(e._node, "active-action"));
			});
		}
	});
	L.Control.PMButton = Ro;
	var Oo = L.Class.extend({
		options: {
			drawMarker: !0,
			drawRectangle: !0,
			drawPolyline: !0,
		...
		applyIconStyle() {
			let t = this.getButtons(), e = { geomanIcons: {
		...
		toggleButton(t, e, i = !0) {
			...
			let r = t;
			return i && this.triggerClickOnToggledButtons(this.buttons[r]), this.buttons[r] ? this.buttons[r].toggle(e) : !1;
		},
		_defineButtons() {
			let t = {
				className: "control-icon leaflet-pm-icon-marker",
				title: F("buttonTitles.drawMarkerButton"),
				jsClass: "Marker",
				onClick: () => {},
				afterClick: (k, w) => {
				...
				title: F("buttonTitles.drawPolyButton"),
				...
				title: F("buttonTitles.drawLineButton"),
				jsClass: "Line",
				onClick: () => {},
				afterClick: (k, w) => {
					this.map.pm.Draw[w.button._button.jsClass].toggle();
				...
				title: F("buttonTitles.drawCircleButton"),
				...
				title: F("buttonTitles.drawCircleMarkerButton"),
				...
				title: F("buttonTitles.drawRectButton"),
				...
				title: F("buttonTitles.editButton"),
				...
				title: F("buttonTitles.dragButton"),
				...
				title: F("buttonTitles.cutButton"),
				...
				title: F("buttonTitles.deleteButton"),
				...
				title: F("buttonTitles.rotateButton"),
				...
				title: F("buttonTitles.drawTextButton"),
				jsClass: "Text",
				onClick: () => {},
				afterClick: (k, w) => {
					this.map.pm.Draw[w.button._button.jsClass].toggle();
			...
			this._addButton("drawMarker", new L.Control.PMButton(t)), this._addButton("drawPolyline", new L.Control.PMButton(i)), this._addButton("drawRectangle", new L.Control.PMButton(s)), this._addButton("drawPolygon", new L.Control.PMButton(e)), this._addButton("drawCircle", new L.Control.PMButton(r)), this._addButton("drawCircleMarker", new L.Control.PMButton(n)), this._addButton("drawText", new L.Control.PMButton(f)), this._addButton("editMode", new L.Control.PMButton(a)), this._addButton("dragMode", new L.Control.PMButton(o)), this._addButton("cutPolygon", new L.Control.PMButton(h)), this._addButton("removalMode", new L.Control.PMButton(l)), this._addButton("rotateMode", new L.Control.PMButton(d));
		},
		_showHideButtons() {
	...
	var Ae = {
		...
		_handleSnapping(t, e = !1) {
			let i = t.target;
			if (i._snapped = !1, this.throttledList || (this.throttledList = L.Util.throttle(this._handleThrottleSnapping, 100, this)), t?.originalEvent?.altKey || this._map?.pm?.Keyboard.isAltKeyPressed()) return !1;
			let r;
			if (e) {
			...
			let n = this._calcClosestLayer(i.getLatLng(), r);
			if (Object.keys(n).length === 0) return !1;
			let s = n.layer instanceof L.Marker || n.layer instanceof L.CircleMarker || !this.options.snapSegment, a;
			s ? a = n.latlng : a = this._checkPrioritiySnapping(n);
			let o = this.options.snapDistance, h = {
				marker: i,
				shape: this._shape,
				snapLatLng: a,
				segment: n.segment,
			...
			if (this._fireSnapDrag(h.marker, h), this._fireSnapDrag(this._layer, h), n.distance < o) {
				i._orgLatLng = i.getLatLng(), i.setLatLng(a), i._snapped = !0, i._snapInfo = h;
				let l = () => {
					this._snapLatLng = a, this._fireSnap(i, h), this._fireSnap(this._layer, h);
				}, d = this._snapLatLng || {}, f = a || {};
				(d.lat !== f.lat || d.lng !== f.lng) && l();
			} else this._snapLatLng && (this._unsnap(h), i._snapped = !1, i._snapInfo = void 0, this._fireUnsnap(h.marker, h), this._fireUnsnap(this._layer, h));
			return !0;
		},
		_createSnapList() {
			let t = [], e = [], i = this._map;
		...
		_calcClosestLayers(t, e, i = 1) {
			let r = [], n = {};
			e.forEach((a, o) => {
				if (a._parentCopy && a._parentCopy === this._layer || a.getLatLngs?.().flat(5).length < 2) return;
				let h = this._calcLayerDistances(t, a);
				if (h.distance = Math.floor(h.distance), this.debugIndicatorLines) {
					if (!this.debugIndicatorLines[o]) {
						let l = L.polyline([], {
							color: "red",
							pmIgnore: !0
						});
						l._pmTempLayer = !0, this.debugIndicatorLines[o] = l;
					}
					this.debugIndicatorLines[o].setLatLngs([t, h.latlng]);
				}
				i === 1 && (n.distance === void 0 || h.distance - 5 <= n.distance) ? (h.distance + 5 < n.distance && (r = []), n = h, n.layer = a, r.push(n)) : i !== 1 && (n = {}, n = h, n.layer = a, r.push(n));
			...
			let n, s, a, o = (h) => {
				h.forEach((l, d) => {
					...
					if (this.options.snapSegment) {
						let f = l, k;
						r ? k = d + 1 === h.length ? 0 : d + 1 : k = d + 1 === h.length ? void 0 : d + 1;
						let w = h[k];
						if (w) {
							let S = this._getDistanceToSegment(i, t, f, w);
							(s === void 0 || S < s) && (s = S, a = [f, w]);
						}
					} else {
		...
		_getClosestLayerByPriority(t, e = 1) {
			...
			let i = [
				...
				"Polygon",
				"Rectangle"
			], r = this._map.pm.globalOptions.snappingOrder || [], n = 0, s = {};
			return r.concat(i).forEach((a) => {
				s[a] || (n += 1, s[a] = n);
			}), t.sort(To("instanceofShape", s)), e === 1 ? t[0] || {} : t.slice(0, e);
		},
		_checkPrioritiySnapping(t) {
			let e = this._map, i = t.segment[0], r = t.segment[1], n = t.latlng, s = n;
			if (this.options.snapVertex) {
				let a = this._getDistance(e, i, n), o = this._getDistance(e, r, n), h = a < o ? i : r, l = a < o ? a : o;
		...
		_getClosestPointOnSegment(t, e, i, r) {
			let n = t.getMaxZoom();
			n === Infinity && (n = t.getZoom());
			let s = t.project(e, n), a = t.project(i, n), o = t.project(r, n), h = L.LineUtil.closestPointOnSegment(s, a, o);
			return t.unproject(h, n);
		},
	...
	var Y = L.Class.extend({
		...
		initialize(t) {
			...
			e.options.tooltipAnchor = [0, 0], this.options.markerStyle.icon = e, this._map = t, this.shapes = [
				"Marker",
				"CircleMarker",
				"Line",
				"Polygon",
		...
		setPathOptions(t, e = !1) {
			e ? this.options.pathOptions = (0, Io.default)(this.options.pathOptions, t) : this.options.pathOptions = t;
		},
		getShapes() {
			return this.shapes;
		},
	...
	Y.Marker = Y.extend({
		initialize(t) {
			this._map = t, this._shape = "Marker", this.toolbarButtonName = "drawMarker", this._layerIsDragging = !1;
		},
		enable(t) {
			L.Util.setOptions(this, t), this._enabled = !0, this._isTouchDevice = !So(), this._map.getContainer().classList.add("geoman-draw-cursor"), this._map.on("click", this._createMarker, this), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this._isTouchDevice ? (this._createTouchHint(), this._hintMarker = L.marker(this._map.getCenter(), {
				...
				opacity: 0,
				interactive: !1
			}), this._setPane(this._hintMarker, "markerPane"), this._hintMarker._pmTempLayer = !0) : (this._hintMarker = L.marker(this._map.getCenter(), this.options.markerStyle), this._setPane(this._hintMarker, "markerPane"), this._hintMarker._pmTempLayer = !0, this._hintMarker.addTo(this._map), this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.placeMarker"), {
				permanent: !0,
				offset: L.point(0, 10),
				direction: "bottom",
				opacity: .8
			}).openTooltip(), this._map.on("mousemove", this._syncHintMarker, this)), this._layer = this._hintMarker, this.options.markerEditable && this._map.eachLayer((e) => {
				this.isRelevantMarker(e) && e.pm.enable();
			}), this._fireDrawStart(), this._setGlobalDrawMode();
		},
		disable() {
			this._enabled && (this._enabled = !1, this._map.getContainer().classList.remove("geoman-draw-cursor"), this._map.off("click", this._createMarker, this), this._isTouchDevice ? (this._removeTouchHint(), this._hintMarker = null) : (this._hintMarker.remove(), this._map.off("mousemove", this._syncHintMarker, this)), this._map.eachLayer((t) => {
		...
		_createTouchHint() {
			this.options.tooltips && (this._touchHint = L.DomUtil.create("div", "leaflet-pm-touch-hint"), this._touchHint.textContent = F("tooltips.placeMarkerTouch"), this._map.getContainer().appendChild(this._touchHint));
		},
		_removeTouchHint() {
	...
	function bt(t, e, i = {}) {
		...
		if (!Ao(t[0]) || !Ao(t[1])) throw new Error("coordinates must contain numbers");
		return ct({
			type: "Point",
			coordinates: t
		}, e, i);
	...
	function $g(t) {
		...
		return e.forEach((n) => {
			e.forEach((s) => {
				for (let a = 0; a < n.length - 1; a++) for (let o = a; o < s.length - 1; o++) {
					if (n === s && (Math.abs(a - o) === 1 || a === 0 && o === n.length - 2 && n[a][0] === n[n.length - 1][0] && n[a][1] === n[n.length - 1][1])) continue;
					let h = Zg(n[a][0], n[a][1], n[a + 1][0], n[a + 1][1], s[o][0], s[o][1], s[o + 1][0], s[o + 1][1]);
					h && r.features.push(bt([h[0], h[1]]));
				}
			});
		}), r;
	}
	function Zg(t, e, i, r, n, s, a, o) {
		let h, l, d, f, k, w = {
			x: null,
			y: null,
			onLine1: !1,
		...
		return h = (o - s) * (i - t) - (a - n) * (r - e), h === 0 ? w.x !== null && w.y !== null ? w : !1 : (l = e - s, d = t - n, f = (a - n) * l - (o - s) * d, k = (i - t) * l - (r - e) * d, l = f / h, d = k / h, w.x = t + l * (i - t), w.y = e + l * (r - e), l >= 0 && l <= 1 && (w.onLine1 = !0), d >= 0 && d <= 1 && (w.onLine2 = !0), w.onLine1 && w.onLine2 ? [w.x, w.y] : !1);
	}
	var Wt = $g;
	Y.Line = Y.extend({
		initialize(t) {
		...
		enable(t) {
			...
			}), this._setPane(this._hintMarker, "vertexPane"), this._hintMarker._pmTempLayer = !0, this._layerGroup.addLayer(this._hintMarker), this.options.cursorMarker && L.DomUtil.addClass(this._hintMarker._icon, "visible"), this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.firstVertex"), {
				permanent: !0,
				offset: L.point(0, 10),
				direction: "bottom",
				opacity: .8
		...
		_setTooltipText() {
			...
			t <= 1 ? e = F("tooltips.continueLine") : e = F("tooltips.finishLine"), this._hintMarker.setTooltipContent(e);
		},
		_change(t) {
	...
	Y.Polygon = Y.Line.extend({
		...
		_setTooltipText() {
			let { length: t } = this._layer.getLatLngs().flat(), e = "";
			t <= 2 ? e = F("tooltips.continueLine") : e = F("tooltips.finishPoly"), this._hintMarker.setTooltipContent(e);
		},
		_finishShape() {
	...
	Y.Rectangle = Y.extend({
		...
		_placeStartingMarkers(t) {
			...
			}), this._map.off("click", this._placeStartingMarkers, this), this._map.on("click", this._finishShape, this), this._hintMarker.setTooltipContent(F("tooltips.finishRect")), this._setRectangleOrigin();
		},
		_setRectangleOrigin() {
		...
		_finishShape(t) {
			t?.latlng && !this._hintMarker._snapped && this._hintMarker.setLatLng(t.latlng);
	...
	Y.CircleMarker = Y.extend({
		...
		enable(t) {
			if (L.Util.setOptions(this, t), this.options.editable && (this.options.resizeableCircleMarker = this.options.editable, delete this.options.editable), this._enabled = !0, this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this._map.getContainer().classList.add("geoman-draw-cursor"), this.options[this._editableOption]) {
				...
				L.extend(e, this.options.templineStyle), e.radius = 0, this._layerGroup = new L.FeatureGroup(), this._layerGroup._pmTempLayer = !0, this._layerGroup.addTo(this._map), this._layer = new this._BaseCircleClass(this._map.getCenter(), e), this._setPane(this._layer, "layerPane"), this._layer._pmTempLayer = !0, this._centerMarker = L.marker(this._map.getCenter(), {
					...
					zIndexOffset: 110,
					icon: L.divIcon({ className: "marker-icon cursor-marker" })
				}), this._setPane(this._hintMarker, "vertexPane"), this._hintMarker._pmTempLayer = !0, this._layerGroup.addLayer(this._hintMarker), this.options.cursorMarker && L.DomUtil.addClass(this._hintMarker._icon, "visible"), this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.startCircle"), {
					permanent: !0,
					offset: L.point(0, 10),
					direction: "bottom",
					opacity: .8
				...
				...this.options.templineStyle
			}), this._setPane(this._hintMarker, "layerPane"), this._hintMarker._pmTempLayer = !0, this._hintMarker.addTo(this._map), this._layer = this._hintMarker, this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.placeCircleMarker"), {
				permanent: !0,
				offset: L.point(0, 10),
				direction: "bottom",
				opacity: .8
		...
		_placeCircleCenter() {
			...
			t && (this._layer.setLatLng(t), this._hintMarker.on("move", this._syncHintLine, this), this._hintMarker.on("move", this._syncCircleRadius, this), this._hintMarker.setTooltipContent(F("tooltips.finishCircle")), this._fireCenterPlaced(), this._fireChange(this._layer.getLatLng(), "Draw"));
		},
		_syncHintLine() {
		...
		_createMarker(t) {
			...
			this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
			let e = this._hintMarker.getLatLng(), i = new this._BaseCircleClass(e, {
				radius: this._defaultRadius,
		...
		_getNewDestinationOfHintMarker() {
			...
			if (this.options[this._editableOption]) {
				...
				this.options[this._minRadiusOption] && i < this.options[this._minRadiusOption] ? t = Zt(this._map, e, t, this._getMinDistanceInMeter()) : this.options[this._maxRadiusOption] && i > this.options[this._maxRadiusOption] && (t = Zt(this._map, e, t, this._getMaxDistanceInMeter()));
			}
			return t;
		},
	...
	Y.Circle = Y.CircleMarker.extend({
		initialize(t) {
	...
	var ze = class {
		...
		_down(e) {
			...
			for (; e < n;) {
				let a = (e << 1) + 1, o = i[a], h = a + 1;
				if (h < this.length && r(i[h], o) < 0 && (a = h, o = i[h]), r(o, s) >= 0) break;
				i[e] = o, e = a;
			}
			i[e] = s;
		}
	...
	function tm(t, e) {
		if (t.type === "FeatureCollection") {
			let i = t.features;
			for (let r = 0; r < i.length; r++) qo(i[r], e);
		} else qo(t, e);
	}
	var Ge = 0, qe = 0, Ne = 0;
	function qo(t, e) {
		...
		for (let n = 0; n < r.length; n++) for (let s = 0; s < r[n].length; s++) {
			let a = r[n][s][0], o = null;
			qe = qe + 1;
			for (let h = 0; h < r[n][s].length - 1; h++) {
				o = r[n][s][h + 1];
				let l = new Fe(a, Ge, qe, Ne), d = new Fe(o, Ge, qe, Ne + 1);
				l.otherEvent = d, d.otherEvent = l, No(l, d) > 0 ? (d.isLeftEndpoint = !0, l.isLeftEndpoint = !1) : (l.isLeftEndpoint = !0, d.isLeftEndpoint = !1), e.push(l), e.push(d), a = o, Ne = Ne + 1;
			}
		}
		Ge = Ge + 1;
	}
	...
	function em(t, e) {
		...
		let i = t.leftSweepEvent.p.x, r = t.leftSweepEvent.p.y, n = t.rightSweepEvent.p.x, s = t.rightSweepEvent.p.y, a = e.leftSweepEvent.p.x, o = e.leftSweepEvent.p.y, h = e.rightSweepEvent.p.x, l = e.rightSweepEvent.p.y, d = (l - o) * (n - i) - (h - a) * (s - r), f = (h - a) * (r - o) - (l - o) * (i - a), k = (n - i) * (r - o) - (s - r) * (i - a);
		if (d === 0) return !1;
		let w = f / d, S = k / d;
		if (w >= 0 && w <= 1 && S >= 0 && S <= 1) return [i + w * (n - i), r + w * (s - r)];
		return !1;
	}
	function im(t, e) {
		e = e || !1;
		...
		for (; t.length;) {
			...
			if (n.isLeftEndpoint) {
				...
				for (let a = 0; a < r.data.length; a++) {
					let o = r.data[a];
					if (e && o.leftSweepEvent.featureId === n.featureId) continue;
					let h = em(s, o);
					h !== !1 && i.push(h);
				}
				r.push(s);
	...
	function rm(t, e) {
		let i = new ze([], No);
		return tm(t, i), im(i, e);
	}
	var nm = rm;
	function Ci(t, e, i = {}) {
		let { removeDuplicates: r = !0, ignoreSelfIntersections: n = !0 } = i, s = [];
		t.type === "FeatureCollection" ? s = s.concat(t.features) : t.type === "Feature" ? s.push(t) : (t.type === "LineString" || t.type === "Polygon" || t.type === "MultiLineString" || t.type === "MultiPolygon") && s.push(ct(t)), e.type === "FeatureCollection" ? s = s.concat(e.features) : e.type === "Feature" ? s.push(e) : (e.type === "LineString" || e.type === "Polygon" || e.type === "MultiLineString" || e.type === "MultiPolygon") && s.push(ct(e));
		let a = nm(rt(s), n), o = [];
		if (r) {
			let h = {};
			a.forEach((l) => {
		...
		return rt(o.map((h) => bt(h)));
	}
	var Dt = Ci;
	var Vo = wt(Fo(), 1);
	function Le(t, e, i) {
		if (t !== null) for (var r, n, s, a, o, h, l, d = 0, f = 0, k, w = t.type, S = w === "FeatureCollection", A = w === "Feature", g = S ? t.features.length : 1, M = 0; M < g; M++) {
			l = S ? t.features[M].geometry : A ? t.geometry : t, k = l ? l.type === "GeometryCollection" : !1, o = k ? l.geometries.length : 1;
			for (var m = 0; m < o; m++) {
				var O = 0, R = 0;
				if (a = k ? l.geometries[m] : l, a !== null) {
					h = a.coordinates;
					var I = a.type;
					switch (d = i && (I === "Polygon" || I === "MultiPolygon") ? 1 : 0, I) {
						case null: break;
						case "Point":
							if (e(h, f, M, O, R) === !1) return !1;
							f++, O++;
							break;
						case "LineString":
						case "MultiPoint":
							for (r = 0; r < h.length; r++) {
								if (e(h[r], f, M, O, R) === !1) return !1;
								f++, I === "MultiPoint" && O++;
							}
							I === "LineString" && O++;
							break;
						...
						case "MultiLineString":
							for (r = 0; r < h.length; r++) {
								for (n = 0; n < h[r].length - d; n++) {
									if (e(h[r][n], f, M, O, R) === !1) return !1;
									f++;
								}
						...
						case "MultiPolygon":
							for (r = 0; r < h.length; r++) {
								for (R = 0, n = 0; n < h[r].length; n++) {
									for (s = 0; s < h[r][n].length - d; s++) {
										if (e(h[r][n][s], f, M, O, R) === !1) return !1;
										f++;
									}
									R++;
								}
						...
						case "GeometryCollection":
							for (r = 0; r < a.geometries.length; r++) if (Le(a.geometries[r], e, i) === !1) return !1;
							break;
	...
	function Qt(t, e) {
		...
		else if (t.type === "FeatureCollection") for (var i = 0; i < t.features.length && e(t.features[i], i) !== !1; i++);
	}
	function jo(t, e, i) {
		var r = i;
	...
	function sm(t, e) {
		var i, r, n, s, a, o, h, l, d, f, k = 0, w = t.type === "FeatureCollection", S = t.type === "Feature", A = w ? t.features.length : 1;
		for (i = 0; i < A; i++) {
			for (o = w ? t.features[i].geometry : S ? t.geometry : t, l = w ? t.features[i].properties : S ? t.properties : {}, d = w ? t.features[i].bbox : S ? t.bbox : void 0, f = w ? t.features[i].id : S ? t.id : void 0, h = o ? o.type === "GeometryCollection" : !1, a = h ? o.geometries.length : 1, n = 0; n < a; n++) {
				if (s = h ? o.geometries[n] : o, s === null) {
					if (e(null, k, l, d, f) === !1) return !1;
					continue;
				}
				switch (s.type) {
					case "Point":
					...
					case "MultiLineString":
					case "MultiPolygon":
						if (e(s, k, l, d, f) === !1) return !1;
						break;
					case "GeometryCollection":
						for (r = 0; r < s.geometries.length; r++) if (e(s.geometries[r], k, l, d, f) === !1) return !1;
						break;
					default: throw new Error("Unknown Geometry Type");
				}
			}
	...
	function te(t, e) {
		sm(t, function(i, r, n, s, a) {
			var o = i === null ? null : i.type;
			switch (o) {
				case null:
				case "Point":
				case "LineString":
				case "Polygon": return e(ct(i, n, {
					bbox: s,
					id: a
				}), r, 0) === !1 ? !1 : void 0;
			}
	...
	function Si(t) {
		...
		else if (Array.isArray(t) && t.length === 6) e = [
			t[0],
			t[1],
			t[3],
			t[4]
		];
		else if (t.type === "Feature") e = ut(t);
		else if (t.type === "FeatureCollection") e = ut(t);
	...
	var am = class {
		constructor(t = 9) {
			this.tree = new Vo.default(t), this.tree.toBBox = Si;
		}
		insert(t) {
		...
		load(t) {
			...
			return Array.isArray(t) ? t.forEach(function(i) {
				...
				i.bbox = i.bbox ? i.bbox : ut(i), e.push(i);
			}) : Qt(t, function(i) {
				if (i.type !== "Feature") throw new Error("invalid features");
				i.bbox = i.bbox ? i.bbox : ut(i), e.push(i);
		...
		search(t) {
			return rt(this.tree.search(Si(t)));
		}
		collides(t) {
			return this.tree.collides(Si(t));
		}
		all() {
			return rt(this.tree.all());
		}
		toJSON() {
	...
	function Uo(t, e) {
		if (e = e ?? {}, !xi(e)) throw new Error("options is invalid");
		...
		if (r !== null) {
			switch (r.type) {
				case "Polygon":
					i = mt(r);
					break;
				case "LineString": i = [mt(r)];
			}
			i.forEach((n) => {
				hm(n, t.properties).forEach((a) => {
	...
	function hm(t, e) {
		...
		return t.reduce((r, n) => {
			let s = Tt([r, n], e);
			return s.bbox = cm(r, n), i.push(s), n;
		}), i;
	}
	function cm(t, e) {
		let i = t[0], r = t[1], n = e[0], s = e[1];
		return [
			i < n ? i : n,
			r < s ? r : s,
			i > n ? i : n,
	...
	function je(t, e, i = {}) {
		var r = st(t), n = st(e), s = Bt(n[1] - r[1]), a = Bt(n[0] - r[0]), o = Bt(r[1]), h = Bt(n[1]), l = Math.pow(Math.sin(s / 2), 2) + Math.pow(Math.sin(a / 2), 2) * Math.cos(o) * Math.cos(h);
		return Go(2 * Math.atan2(Math.sqrt(l), Math.sqrt(1 - l)), i.units);
	}
	var um = Object.defineProperty, pm = Object.defineProperties, fm = Object.getOwnPropertyDescriptors, Ho = Object.getOwnPropertySymbols, dm = Object.prototype.hasOwnProperty, gm = Object.prototype.propertyIsEnumerable, Xo = (t, e, i) => e in t ? um(t, e, {
		enumerable: !0,
		configurable: !0,
		writable: !0,
		value: i
	}) : t[e] = i, mm = (t, e) => {
		for (var i in e || (e = {})) dm.call(e, i) && Xo(t, i, e[i]);
		if (Ho) for (var i of Ho(e)) gm.call(e, i) && Xo(t, i, e[i]);
		return t;
	}, _m = (t, e) => pm(t, fm(e));
	function Jo(t, e, i = {}) {
		if (!t || !e) throw new Error("lines and inputPoint are required arguments");
		let r = st(e), n = bt([Infinity, Infinity], {
			lineStringIndex: -1,
			segmentIndex: -1,
			totalDistance: -1,
			lineDistance: -1,
		...
		return te(t, function(h, l, d) {
			o !== d && (o = d, a = 0);
			let f = mt(h);
			for (let k = 0; k < f.length - 1; k++) {
				let w = bt(f[k]), S = st(w), A = bt(f[k + 1]), g = st(A), M = je(w, A, i), m, O;
				g[0] === r[0] && g[1] === r[1] ? [m, O] = [g, !0] : S[0] === r[0] && S[1] === r[1] ? [m, O] = [S, !1] : [m, O] = bm(S, g, r);
				let R = je(e, m, i);
				if (R < n.properties.pointDistance) {
					let I = je(w, m, i);
					n = bt(m, {
						lineStringIndex: d,
						segmentIndex: O ? k + 1 : k,
						totalDistance: s + I,
						lineDistance: a + I,
						segmentDistance: I,
						pointDistance: R,
						...
						location: -1,
						dist: Infinity
					}), n.properties = _m(mm({}, n.properties), {
						multiFeatureIndex: n.properties.lineStringIndex,
						index: n.properties.segmentIndex,
						location: n.properties.totalDistance,
						dist: n.properties.pointDistance
					});
				}
				s += M, a += M;
			}
	...
	function Di(t) {
		let e = Bt(t[1]), i = Bt(t[0]);
		return [
			Math.cos(e) * Math.cos(i),
			Math.cos(e) * Math.sin(i),
			Math.sin(e)
		];
	}
	function Lm(t) {
		let [e, i, r] = t, s = vi(Math.asin(Math.min(Math.max(r, -1), 1)));
		return [vi(Math.atan2(i, e)), s];
	}
	function bm(t, e, i) {
		let r = Di(t), n = Di(e), s = Di(i), a = be(r, n);
		if (a[0] === 0 && a[1] === 0 && a[2] === 0) return Gt(r, n) > 0 ? [[...e], !0] : [[...i], !1];
		let o = be(a, s);
		if (o[0] === 0 && o[1] === 0 && o[2] === 0) return [[...e], !0];
		let l = Yo(be(o, a)), d = [
			-l[0],
			-l[1],
			-l[2]
		], f = Gt(s, l) > Gt(s, d) ? l : d, k = Yo(a), w = Gt(be(r, f), k), S = Gt(be(f, n), k);
		return w >= 0 && S >= 0 ? [Lm(f), !1] : Gt(r, s) > Gt(n, s) ? [[...t], !1] : [[...e], !0];
	}
	function Ii(t, e) {
		...
		var n = Uo(e, { precision: 7 });
		switch (t.type !== "Feature" && (t = ct(t)), r) {
			case "Point": return Oi(t, n);
			case "MultiPoint": return $o(t, n);
			case "LineString":
			case "MultiLineString":
			case "Polygon":
			case "MultiPolygon": return $o(t, Ci(t, n, { ignoreSelfIntersections: !0 }));
		}
	}
	function $o(t, e) {
		var i = [], r = Ti();
		return te(e, function(n) {
			if (i.forEach(function(o, h) {
				o.id = h;
			}), !i.length) i = Oi(t, n).features, r.load(rt(i));
			else {
				var s = r.search(n);
				if (s.features.length) {
					...
					i = i.filter(function(o) {
						return o.id !== a.id;
					}), r.remove(a), Qt(Oi(a, n), function(o) {
						i.push(o), r.insert(o);
					});
				}
			}
	...
	function Oi(t, e) {
		...
		if (Ri(r, st(e)) || Ri(n, st(e))) return rt([t]);
		var s = Ti(), a = Ko(t);
		s.load(a);
		var o = s.search(e);
		if (!o.features.length) return rt([t]);
		var h = Zo(e, o), d = jo(a, function(f, k, w) {
			var S = mt(k)[1], A = st(e);
			return w === h.id ? (f.push(A), i.push(Tt(f)), Ri(A, S) ? [A] : [A, S]) : (f.push(S), f);
		}, [r]);
		return d.length > 1 && i.push(Tt(d)), rt(i);
	}
	function Zo(t, e) {
	...
	var Wo = Ii;
	var V = 11102230246251565e-32, Q = 134217729, ke = (3 + 8 * V) * V;
	function qt(t, e, i, r, n) {
		let s, a, o, h, l = e[0], d = r[0], f = 0, k = 0;
		d > l == d > -l ? (s = l, l = e[++f]) : (s = d, d = r[++k]);
		let w = 0;
		if (f < t && k < i) for (d > l == d > -l ? (a = l + s, o = s - (a - l), l = e[++f]) : (a = d + s, o = s - (a - d), d = r[++k]), s = a, o !== 0 && (n[w++] = o); f < t && k < i;) d > l == d > -l ? (a = s + l, h = a - s, o = s - (a - h) + (l - h), l = e[++f]) : (a = s + d, h = a - s, o = s - (a - h) + (d - h), d = r[++k]), s = a, o !== 0 && (n[w++] = o);
		for (; f < t;) a = s + l, h = a - s, o = s - (a - h) + (l - h), l = e[++f], s = a, o !== 0 && (n[w++] = o);
		for (; k < i;) a = s + d, h = a - s, o = s - (a - h) + (d - h), d = r[++k], s = a, o !== 0 && (n[w++] = o);
	...
	var km = (3 + 16 * V) * V, Mm = (2 + 12 * V) * V, vm = (9 + 64 * V) * V * V, ie = D(4), Qo = D(8), tl = D(12), el = D(16), at = D(4);
	function xm(t, e, i, r, n, s, a) {
		let o, h, l, d, f, k, w, S, A, g, M, m, O, R, I, G, q, c, u = t - n, p = i - n, y = e - s, _ = r - s;
		R = u * _, k = Q * u, w = k - (k - u), S = u - w, k = Q * _, A = k - (k - _), g = _ - A, I = S * g - (R - w * A - S * A - w * g), G = y * p, k = Q * y, w = k - (k - y), S = y - w, k = Q * p, A = k - (k - p), g = p - A, q = S * g - (G - w * A - S * A - w * g), M = I - q, f = I - M, ie[0] = I - (M + f) + (f - q), m = R + M, f = m - R, O = R - (m - f) + (M - f), M = O - G, f = O - M, ie[1] = O - (M + f) + (f - G), c = m + M, f = c - m, ie[2] = m - (c - f) + (M - f), ie[3] = c;
		let v = Me(4, ie), E = Mm * a;
		if (v >= E || -v >= E || (f = t - u, o = t - (u + f) + (f - n), f = i - p, l = i - (p + f) + (f - n), f = e - y, h = e - (y + f) + (f - s), f = r - _, d = r - (_ + f) + (f - s), o === 0 && h === 0 && l === 0 && d === 0) || (E = vm * a + ke * Math.abs(v), v += u * d + _ * o - (y * l + p * h), v >= E || -v >= E)) return v;
		R = o * _, k = Q * o, w = k - (k - o), S = o - w, k = Q * _, A = k - (k - _), g = _ - A, I = S * g - (R - w * A - S * A - w * g), G = h * p, k = Q * h, w = k - (k - h), S = h - w, k = Q * p, A = k - (k - p), g = p - A, q = S * g - (G - w * A - S * A - w * g), M = I - q, f = I - M, at[0] = I - (M + f) + (f - q), m = R + M, f = m - R, O = R - (m - f) + (M - f), M = O - G, f = O - M, at[1] = O - (M + f) + (f - G), c = m + M, f = c - m, at[2] = m - (c - f) + (M - f), at[3] = c;
		let b = qt(4, ie, 4, at, Qo);
		R = u * d, k = Q * u, w = k - (k - u), S = u - w, k = Q * d, A = k - (k - d), g = d - A, I = S * g - (R - w * A - S * A - w * g), G = y * l, k = Q * y, w = k - (k - y), S = y - w, k = Q * l, A = k - (k - l), g = l - A, q = S * g - (G - w * A - S * A - w * g), M = I - q, f = I - M, at[0] = I - (M + f) + (f - q), m = R + M, f = m - R, O = R - (m - f) + (M - f), M = O - G, f = O - M, at[1] = O - (M + f) + (f - G), c = m + M, f = c - m, at[2] = m - (c - f) + (M - f), at[3] = c;
		let x = qt(b, Qo, 4, at, tl);
		R = o * d, k = Q * o, w = k - (k - o), S = o - w, k = Q * d, A = k - (k - d), g = d - A, I = S * g - (R - w * A - S * A - w * g), G = h * l, k = Q * h, w = k - (k - h), S = h - w, k = Q * l, A = k - (k - l), g = l - A, q = S * g - (G - w * A - S * A - w * g), M = I - q, f = I - M, at[0] = I - (M + f) + (f - q), m = R + M, f = m - R, O = R - (m - f) + (M - f), M = O - G, f = O - M, at[1] = O - (M + f) + (f - G), c = m + M, f = c - m, at[2] = m - (c - f) + (M - f), at[3] = c;
		return el[qt(x, tl, 4, at, el) - 1];
	}
	function Ai(t, e, i, r, n, s) {
		let a = (e - s) * (i - n), o = (t - n) * (r - s), h = a - o, l = Math.abs(a + o);
		return Math.abs(h) >= km * l ? h : -xm(t, e, i, r, n, s, l);
	}
	(7 + 56 * V) * V;
	(3 + 28 * V) * V;
	(26 + 288 * V) * V * V;
	...
	D(1152);
	function rl(t, e) {
		var i, r, n = 0, s, a, o, h, l, d, f, k = t[0], w = t[1], S = e.length;
		for (i = 0; i < S; i++) {
			r = 0;
			var A = e[i], g = A.length - 1;
			if (d = A[0], d[0] !== A[g][0] && d[1] !== A[g][1]) throw new Error("First and last coordinates in a ring must be the same");
			for (a = d[0] - k, o = d[1] - w; r < g; r++) {
				if (f = A[r + 1], h = f[0] - k, l = f[1] - w, o === 0 && l === 0) {
					if (h <= 0 && a >= 0 || a <= 0 && h >= 0) return 0;
				} else if (l >= 0 && o <= 0 || l <= 0 && o >= 0) {
					if (s = Ai(a, h, o, l, 0, 0), s === 0) return 0;
					(s > 0 && l > 0 && o <= 0 || s < 0 && l <= 0 && o > 0) && n++;
				}
				d = f, o = l, a = h;
			}
		}
	...
	function Nt(t, e, i = {}) {
		...
		let r = st(t), n = ee(e), s = n.type, a = e.bbox, o = n.coordinates;
		if (a && Cm(r, a) === !1) return !1;
		s === "Polygon" && (o = [o]);
		let h = !1;
	...
	function re(t, e, i = {}) {
		...
		for (let s = 0; s < n.length - 1; s++) {
			let a = !1;
			if (i.ignoreEndVertices && (s === 0 && (a = "start"), s === n.length - 2 && (a = "end"), s === 0 && s + 1 === n.length - 1 && (a = "both")), Em(n[s], n[s + 1], r, a, typeof i.epsilon > "u" ? null : i.epsilon)) return !0;
		}
		return !1;
	}
	function Em(t, e, i, r, n) {
		let s = i[0], a = i[1], o = t[0], h = t[1], l = e[0], d = e[1], f = i[0] - o, k = i[1] - h, w = l - o, S = d - h, A = f * S - k * w;
		if (n !== null) {
			if (Math.abs(A) > n) return !1;
		} else if (A !== 0) return !1;
		if (Math.abs(w) === Math.abs(S) && Math.abs(w) === 0) return r ? !1 : i[0] === t[0] && i[1] === t[1];
		if (r) {
			if (r === "start") return Math.abs(w) >= Math.abs(S) ? w > 0 ? o < s && s <= l : l <= s && s < o : S > 0 ? h < a && a <= d : d <= a && a < h;
			if (r === "end") return Math.abs(w) >= Math.abs(S) ? w > 0 ? o <= s && s < l : l < s && s <= o : S > 0 ? h <= a && a < d : d < a && a <= h;
			if (r === "both") return Math.abs(w) >= Math.abs(S) ? w > 0 ? o < s && s < l : l < s && s < o : S > 0 ? h < a && a < d : d < a && a < h;
		} else return Math.abs(w) >= Math.abs(S) ? w > 0 ? o <= s && s <= l : l <= s && s <= o : S > 0 ? h <= a && a <= d : d <= a && a <= h;
		return !1;
	}
	function Pm(t, e) {
		let i = ee(t), r = ee(e), n = i.type, s = r.type, a = i.coordinates, o = r.coordinates;
		switch (n) {
			case "Point":
				if (s === "Point") return qi(a, o);
				throw new Error("feature2 " + s + " geometry not supported");
			case "MultiPoint": switch (s) {
				case "Point": return Bm(i, r);
				case "MultiPoint": return Dm(i, r);
				default: throw new Error("feature2 " + s + " geometry not supported");
			}
			case "LineString": switch (s) {
				case "Point": return re(r, i, { ignoreEndVertices: !0 });
				case "LineString": return Im(i, r);
				case "MultiPoint": return Rm(i, r);
				default: throw new Error("feature2 " + s + " geometry not supported");
			}
			case "Polygon": switch (s) {
				case "Point": return Nt(r, i, { ignoreBoundary: !0 });
				case "LineString": return Gm(i, r);
				case "Polygon": return Gi(i, r);
				case "MultiPoint": return Om(i, r);
				case "MultiPolygon": return Tm(i, r);
				default: throw new Error("feature2 " + s + " geometry not supported");
			}
			case "MultiPolygon":
				if (s === "Polygon") return Sm(i, r);
				throw new Error("feature2 " + s + " geometry not supported");
			default: throw new Error("feature1 " + n + " geometry not supported");
		}
	}
	function Sm(t, e) {
		return t.coordinates.some((i) => Gi({
			type: "Polygon",
			coordinates: i
		}, e));
	}
	function Tm(t, e) {
		return e.coordinates.every((i) => Gi(t, {
			type: "Polygon",
			coordinates: i
		}));
	}
	function Bm(t, e) {
		let i, r = !1;
		for (i = 0; i < t.coordinates.length; i++) if (qi(t.coordinates[i], e.coordinates)) {
			r = !0;
			break;
		}
		return r;
	...
	function Dm(t, e) {
		for (let i of e.coordinates) {
			let r = !1;
			for (let n of t.coordinates) if (qi(i, n)) {
				r = !0;
				break;
			}
			if (!r) return !1;
	...
	function Rm(t, e) {
		let i = !1;
		for (let r of e.coordinates) if (re(r, t, { ignoreEndVertices: !0 }) && (i = !0), !re(r, t)) return !1;
		return !!i;
	}
	function Om(t, e) {
		for (let i of e.coordinates) if (!Nt(i, t, { ignoreBoundary: !0 })) return !1;
		return !0;
	}
	function Im(t, e) {
		let i = !1;
		for (let r of e.coordinates) if (re({
			type: "Point",
			coordinates: r
		}, t, { ignoreEndVertices: !0 }) && (i = !0), !re({
			type: "Point",
			coordinates: r
	...
	function Am(t, e) {
		let i = t.coordinates, r = [];
		for (let n = 0; n < i.length - 1; n++) {
			let s = Tt([i[n], i[n + 1]]), a = Ii(s, ct(e));
			a.features.length === 0 ? r.push(s) : r.push(...a.features);
		}
		return rt(r);
	}
	function Gm(t, e) {
		if (!nl(ut(t), ut(e))) return !1;
		for (let a of e.coordinates) if (!Nt(a, t)) return !1;
		let n = !1, s = Am(e, t);
		for (let a of s.features) {
			let o = qm(a.geometry.coordinates[0], a.geometry.coordinates[1]);
			if (!Nt(o, t)) return !1;
			!n && Nt(o, t, { ignoreBoundary: !0 }) && (n = !0);
		}
		return n;
	}
	function Gi(t, e) {
		...
		for (let s of n) for (let a of s) if (!Nt(a, t)) return !1;
		return !0;
	}
	function nl(t, e) {
	...
	var sl = Pm;
	var El = wt(ge());
	var Nm = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, Ni = Math.ceil, ft = Math.floor, ot = "[BigNumber Error] ", al = ot + "Number primitive has more than 15 significant digits: ", _t = 0x5af3107a4000, j = 14, zi = 9007199254740991, Fi = [
		1,
		10,
		100,
		1e3,
	...
	function ol(t) {
		var e, i, r, n = m.prototype = {
			constructor: m,
			toString: null,
			valueOf: null
		}, s = new m(1), a = 20, o = 4, h = -7, l = 21, d = -1e7, f = 1e7, k = !1, w = 1, S = 0, A = {
			prefix: "",
			groupSize: 3,
		...
		function m(c, u) {
			var p, y, _, v, E, b, x, P, C = this;
			if (!(C instanceof m)) return new m(c, u);
			if (u == null) {
				if (c && c._isBigNumber === !0) {
					C.s = c.s, !c.c || c.e > f ? C.c = C.e = null : c.e < d ? C.c = [C.e = 0] : (C.e = c.e, C.c = c.c.slice());
					return;
				}
				if ((b = typeof c == "number") && c * 0 == 0) {
					if (C.s = 1 / c < 0 ? (c = -c, -1) : 1, c === ~~c) {
						for (v = 0, E = c; E >= 10; E /= 10, v++);
						v > f ? C.c = C.e = null : (C.e = v, C.c = [c]);
						return;
					}
					P = String(c);
				} else {
					if (!Nm.test(P = String(c))) return r(C, P, b);
				...
				if ($(u, 2, g.length, "Base"), u == 10 && M) return C = new m(c), G(C, a + C.e + 1, o);
				if (P = String(c), b = typeof c == "number") {
					if (c * 0 != 0) return r(C, P, b, u);
					if (C.s = 1 / c < 0 ? (P = P.slice(1), -1) : 1, m.DEBUG && P.replace(/^0\.0*|\./, "").length > 15) throw Error(al + c);
				...
				for (p = g.slice(0, u), v = E = 0, x = P.length; E < x; E++) if (p.indexOf(y = P.charAt(E)) < 0) {
					...
					} else if (!_ && (P == P.toUpperCase() && (P = P.toLowerCase()) || P == P.toLowerCase() && (P = P.toUpperCase()))) {
						_ = !0, E = -1, v = 0;
						continue;
					}
					return r(C, String(c), b, u);
				}
				b = !1, P = i(P, u, 10, C.s), (v = P.indexOf(".")) > -1 ? P = P.replace(".", "") : v = P.length;
			}
			for (E = 0; P.charCodeAt(E) === 48; E++);
			for (x = P.length; P.charCodeAt(--x) === 48;);
			if (P = P.slice(E, ++x)) {
				if (x -= E, b && m.DEBUG && x > 15 && (c > zi || c !== ft(c))) throw Error(al + C.s * c);
				if ((v = v - E - 1) > f) C.c = C.e = null;
				else if (v < d) C.c = [C.e = 0];
				else {
					if (C.e = v, C.c = [], E = (v + 1) % j, v < 0 && (E += j), E < x) {
						for (E && C.c.push(+P.slice(0, E)), x -= j; E < x;) C.c.push(+P.slice(E, E += j));
						E = j - (P = P.slice(E)).length;
					} else E -= x;
					for (; E--; P += "0");
					C.c.push(+P);
				}
		...
		m.clone = ol, m.ROUND_UP = 0, m.ROUND_DOWN = 1, m.ROUND_CEIL = 2, m.ROUND_FLOOR = 3, m.ROUND_HALF_UP = 4, m.ROUND_HALF_DOWN = 5, m.ROUND_HALF_EVEN = 6, m.ROUND_HALF_CEIL = 7, m.ROUND_HALF_FLOOR = 8, m.EUCLID = 9, m.config = m.set = function(c) {
			var u, p;
			if (c != null) if (typeof c == "object") {
				if (c.hasOwnProperty(u = "DECIMAL_PLACES") && (p = c[u], $(p, 0, et, u), a = p), c.hasOwnProperty(u = "ROUNDING_MODE") && (p = c[u], $(p, 0, 8, u), o = p), c.hasOwnProperty(u = "EXPONENTIAL_AT") && (p = c[u], p && p.pop ? ($(p[0], -et, 0, u), $(p[1], 0, et, u), h = p[0], l = p[1]) : ($(p, -et, et, u), h = -(l = p < 0 ? -p : p))), c.hasOwnProperty(u = "RANGE")) if (p = c[u], p && p.pop) $(p[0], -et, -1, u), $(p[1], 1, et, u), d = p[0], f = p[1];
				else if ($(p, -et, et, u), p) d = -(f = p < 0 ? -p : p);
				else throw Error(ot + u + " cannot be zero: " + p);
				if (c.hasOwnProperty(u = "CRYPTO")) if (p = c[u], p === !!p) if (p) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) k = p;
				else throw k = !p, Error(ot + "crypto unavailable");
				else k = p;
				else throw Error(ot + u + " not true or false: " + p);
				if (c.hasOwnProperty(u = "MODULO_MODE") && (p = c[u], $(p, 0, 9, u), w = p), c.hasOwnProperty(u = "POW_PRECISION") && (p = c[u], $(p, 0, et, u), S = p), c.hasOwnProperty(u = "FORMAT")) if (p = c[u], typeof p == "object") A = p;
				else throw Error(ot + u + " not an object: " + p);
				if (c.hasOwnProperty(u = "ALPHABET")) if (p = c[u], typeof p == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(p)) M = p.slice(0, 10) == "0123456789", g = p;
				else throw Error(ot + u + " invalid: " + p);
			} else throw Error(ot + "Object expected: " + c);
			return {
				DECIMAL_PLACES: a,
				ROUNDING_MODE: o,
				EXPONENTIAL_AT: [h, l],
		...
		}, m.isBigNumber = function(c) {
			if (!c || c._isBigNumber !== !0) return !1;
			if (!m.DEBUG) return !0;
			var u, p, y = c.c, _ = c.e, v = c.s;
			t: if ({}.toString.call(y) == "[object Array]") {
				if ((v === 1 || v === -1) && _ >= -et && _ <= et && _ === ft(_)) {
					if (y[0] === 0) {
						if (_ === 0 && y.length === 1) return !0;
						break t;
					}
					if (u = (_ + 1) % j, u < 1 && (u += j), String(y[0]).length == u) {
						for (u = 0; u < y.length; u++) if (p = y[u], p < 0 || p >= _t || p !== ft(p)) break t;
						if (p !== 0) return !0;
					}
				}
			} else if (y === null && _ === null && (v === null || v === 1 || v === -1)) return !0;
			throw Error(ot + "Invalid BigNumber: " + c);
		}, m.maximum = m.max = function() {
			return R(arguments, -1);
		}, m.minimum = m.min = function() {
			return R(arguments, 1);
		}, m.random = (function() {
			var c = 9007199254740992, u = Math.random() * c & 2097151 ? function() {
				return ft(Math.random() * c);
			} : function() {
				return (Math.random() * 1073741824 | 0) * 8388608 + (Math.random() * 8388608 | 0);
			};
			return function(p) {
				var y, _, v, E, b, x = 0, P = [], C = new m(s);
				if (p == null ? p = a : $(p, 0, et), E = Ni(p / j), k) if (crypto.getRandomValues) {
					for (y = crypto.getRandomValues(new Uint32Array(E *= 2)); x < E;) b = y[x] * 131072 + (y[x + 1] >>> 11), b >= 9e15 ? (_ = crypto.getRandomValues(new Uint32Array(2)), y[x] = _[0], y[x + 1] = _[1]) : (P.push(b % 0x5af3107a4000), x += 2);
					x = E / 2;
				} else if (crypto.randomBytes) {
					for (y = crypto.randomBytes(E *= 7); x < E;) b = (y[x] & 31) * 281474976710656 + y[x + 1] * 1099511627776 + y[x + 2] * 4294967296 + y[x + 3] * 16777216 + (y[x + 4] << 16) + (y[x + 5] << 8) + y[x + 6], b >= 9e15 ? crypto.randomBytes(7).copy(y, x) : (P.push(b % 0x5af3107a4000), x += 7);
					x = E / 7;
				} else throw k = !1, Error(ot + "crypto unavailable");
				if (!k) for (; x < E;) b = u(), b < 9e15 && (P[x++] = b % 0x5af3107a4000);
				for (E = P[--x], p %= j, E && p && (b = Fi[j - p], P[x] = ft(E / b) * b); P[x] === 0; P.pop(), x--);
				if (x < 0) P = [v = 0];
				else {
					for (v = -1; P[0] === 0; P.splice(0, 1), v -= j);
			...
			for (var c = 1, u = arguments, p = new m(u[0]); c < u.length;) p = p.plus(u[c++]);
			return p;
		}, i = (function() {
			var c = "0123456789";
			function u(p, y, _, v) {
				for (var E, b = [0], x, P = 0, C = p.length; P < C;) {
					...
					for (b[0] += v.indexOf(p.charAt(P++)), E = 0; E < b.length; E++) b[E] > _ - 1 && (b[E + 1] ?? (b[E + 1] = 0), b[E + 1] += b[E] / _ | 0, b[E] %= _);
				}
				return b.reverse();
			}
			return function(p, y, _, v, E) {
				var b, x, P, C, T, N, z, K, Z = p.indexOf("."), tt = a, U = o;
				for (Z >= 0 && (C = S, S = 0, p = p.replace(".", ""), K = new m(y), N = K.pow(p.length - Z), S = C, K.c = u(Mt(pt(N.c), N.e, "0"), 10, _, c), K.e = K.c.length), z = u(p, y, _, E ? (b = g, c) : (b = c, g)), P = C = z.length; z[--C] == 0; z.pop());
				if (!z[0]) return b.charAt(0);
				if (Z < 0 ? --P : (N.c = z, N.e = P, N.s = v, N = e(N, K, tt, U, _), z = N.c, T = N.r, P = N.e), x = P + tt + 1, Z = z[x], C = _ / 2, T = T || x < 0 || z[x + 1] != null, T = U < 4 ? (Z != null || T) && (U == 0 || U == (N.s < 0 ? 3 : 2)) : Z > C || Z == C && (U == 4 || T || U == 6 && z[x - 1] & 1 || U == (N.s < 0 ? 8 : 7)), x < 1 || !z[0]) p = T ? Mt(b.charAt(1), -tt, b.charAt(0)) : b.charAt(0);
				else {
					if (z.length = x, T) for (--_; ++z[--x] > _;) z[x] = 0, x || (++P, z = [1].concat(z));
					for (C = z.length; !z[--C];);
					for (Z = 0, p = ""; Z <= C; p += b.charAt(z[Z++]));
					p = Mt(p, P, b.charAt(0));
				}
				return p;
			};
			...
			function c(y, _, v) {
				var E, b, x, P, C = 0, T = y.length, N = _ % Rt, z = _ / Rt | 0;
				for (y = y.slice(); T--;) x = y[T] % Rt, P = y[T] / Rt | 0, E = z * x + P * N, b = N * x + E % Rt * Rt + C, C = (b / v | 0) + (E / Rt | 0) + z * P, y[T] = b % v;
				return C && (y = [C].concat(y)), y;
			}
			function u(y, _, v, E) {
				var b, x;
				if (v != E) x = v > E ? 1 : -1;
				else for (b = x = 0; b < v; b++) if (y[b] != _[b]) {
					x = y[b] > _[b] ? 1 : -1;
					break;
				}
				return x;
			...
			function p(y, _, v, E) {
				for (var b = 0; v--;) y[v] -= b, b = y[v] < _[v] ? 1 : 0, y[v] = b * E + y[v] - _[v];
				for (; !y[0] && y.length > 1; y.splice(0, 1));
			}
			return function(y, _, v, E, b) {
				var x, P, C, T, N, z, K, Z, tt, U, H, it, Pe, We, Qe, yt, ne, ht = y.s == _.s ? 1 : -1, nt = y.c, W = _.c;
				if (!nt || !nt[0] || !W || !W[0]) return new m(!y.s || !_.s || (nt ? W && nt[0] == W[0] : !W) ? NaN : nt && nt[0] == 0 || !W ? ht * 0 : ht / 0);
				for (Z = new m(ht), tt = Z.c = [], P = y.e - _.e, ht = v + P + 1, b || (b = _t, P = dt(y.e / j) - dt(_.e / j), ht = ht / j | 0), C = 0; W[C] == (nt[C] || 0); C++);
				if (W[C] > (nt[C] || 0) && P--, ht < 0) tt.push(1), T = !0;
				else {
					for (We = nt.length, yt = W.length, C = 0, ht += 2, N = ft(b / (W[0] + 1)), N > 1 && (W = c(W, N, b), nt = c(nt, N, b), yt = W.length, We = nt.length), Pe = yt, U = nt.slice(0, yt), H = U.length; H < yt; U[H++] = 0);
					ne = W.slice(), ne = [0].concat(ne), Qe = W[0], W[1] >= b / 2 && Qe++;
					do {
						if (N = 0, x = u(W, U, yt, H), x < 0) {
							if (it = U[0], yt != H && (it = it * b + (U[1] || 0)), N = ft(it / Qe), N > 1) for (N >= b && (N = b - 1), z = c(W, N, b), K = z.length, H = U.length; u(z, U, K, H) == 1;) N--, p(z, yt < K ? ne : W, K, b), K = z.length, x = 1;
							else N == 0 && (x = N = 1), z = W.slice(), K = z.length;
							if (K < H && (z = [0].concat(z)), p(U, z, H, b), H = U.length, x == -1) for (; u(W, U, yt, H) < 1;) N++, p(U, yt < H ? ne : W, H, b), H = U.length;
						} else x === 0 && (N++, U = [0]);
						tt[C++] = N, U[0] ? U[H++] = nt[Pe] || 0 : (U = [nt[Pe]], H = 1);
					} while ((Pe++ < We || U[0] != null) && ht--);
					T = U[0] != null, tt[0] || tt.splice(0, 1);
				}
				if (b == _t) {
					for (C = 1, ht = tt[0]; ht >= 10; ht /= 10, C++);
					G(Z, v + (Z.e = C + P * j - 1) + 1, E, T);
				} else Z.e = P, Z.r = +T;
				return Z;
			};
		})();
		function O(c, u, p, y) {
			var _, v, E, b, x;
			if (p == null ? p = o : $(p, 0, 8), !c.c) return c.toString();
			if (_ = c.c[0], E = c.e, u == null) x = pt(c.c), x = y == 1 || y == 2 && (E <= h || E >= l) ? Ue(x, E) : Mt(x, E, "0");
			else if (c = G(new m(c), u, p), v = c.e, x = pt(c.c), b = x.length, y == 1 || y == 2 && (u <= v || v <= h)) {
				for (; b < u; x += "0", b++);
				x = Ue(x, v);
			} else if (u -= E + (y === 2 && v > E), x = Mt(x, v, "0"), v + 1 > b) {
				if (--u > 0) for (x += "."; u--; x += "0");
			} else if (u += v - b, u > 0) for (v + 1 == b && (x += "."); u--; x += "0");
			return c.s < 0 && _ ? "-" + x : x;
		}
		function R(c, u) {
			for (var p, y, _ = 1, v = new m(c[0]); _ < c.length; _++) y = new m(c[_]), (!y.s || (p = zt(v, y)) === u || p === 0 && v.s === u) && (v = y);
			return v;
		}
		function I(c, u, p) {
			for (var y = 1, _ = u.length; !u[--_]; u.pop());
			for (_ = u[0]; _ >= 10; _ /= 10, y++);
			return (p = y + p * j - 1) > f ? c.c = c.e = null : p < d ? c.c = [c.e = 0] : (c.e = p, c.c = u), c;
		}
		r = (function() {
			var c = /^(-?)0([xbo])(?=\w[\w.]*$)/i, u = /^([^.]+)\.$/, p = /^\.([^.]+)$/, y = /^-?(Infinity|NaN)$/, _ = /^\s*\+(?=[\w.])|^\s+|\s+$/g;
			return function(v, E, b, x) {
				var P, C = b ? E : E.replace(_, "");
				if (y.test(C)) v.s = isNaN(C) ? null : C < 0 ? -1 : 1;
				else {
					if (!b && (C = C.replace(c, function(T, N, z) {
						return P = (z = z.toLowerCase()) == "x" ? 16 : z == "b" ? 2 : 8, !x || x == P ? N : T;
					}), x && (P = x, C = C.replace(u, "$1").replace(p, "0.$1")), E != C)) return new m(C, P);
					if (m.DEBUG) throw Error(ot + "Not a" + (x ? " base " + x : "") + " number: " + E);
					v.s = null;
				}
				v.c = v.e = null;
			};
		...
		function G(c, u, p, y) {
			var _, v, E, b, x, P, C, T = c.c, N = Fi;
			if (T) {
				t: {
					for (_ = 1, b = T[0]; b >= 10; b /= 10, _++);
					if (v = u - _, v < 0) v += j, E = u, x = T[P = 0], C = ft(x / N[_ - E - 1] % 10);
					else if (P = Ni((v + 1) / j), P >= T.length) if (y) {
						for (; T.length <= P; T.push(0));
						x = C = 0, _ = 1, v %= j, E = v - j + 1;
					} else break t;
					else {
						for (x = b = T[P], _ = 1; b >= 10; b /= 10, _++);
						v %= j, E = v - j + _, C = E < 0 ? 0 : ft(x / N[_ - E - 1] % 10);
					}
					if (y = y || u < 0 || T[P + 1] != null || (E < 0 ? x : x % N[_ - E - 1]), y = p < 4 ? (C || y) && (p == 0 || p == (c.s < 0 ? 3 : 2)) : C > 5 || C == 5 && (p == 4 || y || p == 6 && (v > 0 ? E > 0 ? x / N[_ - E] : 0 : T[P - 1]) % 10 & 1 || p == (c.s < 0 ? 8 : 7)), u < 1 || !T[0]) return T.length = 0, y ? (u -= c.e + 1, T[0] = N[(j - u % j) % j], c.e = -u || 0) : T[0] = c.e = 0, c;
					if (v == 0 ? (T.length = P, b = 1, P--) : (T.length = P + 1, b = N[j - v], T[P] = E > 0 ? ft(x / N[_ - E] % N[E]) * b : 0), y) for (;;) if (P == 0) {
						for (v = 1, E = T[0]; E >= 10; E /= 10, v++);
						for (E = T[0] += b, b = 1; E >= 10; E /= 10, b++);
						v != b && (c.e++, T[0] == _t && (T[0] = 1));
						break;
					} else {
						if (T[P] += b, T[P] != _t) break;
						T[P--] = 0, b = 1;
					}
					for (v = T.length; T[--v] === 0; T.pop());
				}
				c.e > f ? c.c = c.e = null : c.e < d && (c.c = [c.e = 0]);
			}
			return c;
		}
		function q(c) {
			var u, p = c.e;
			return p === null ? c.toString() : (u = pt(c.c), u = p <= h || p >= l ? Ue(u, p) : Mt(u, p, "0"), c.s < 0 ? "-" + u : u);
		}
		return n.absoluteValue = n.abs = function() {
			var c = new m(this);
			return c.s < 0 && (c.s = 1), c;
		}, n.comparedTo = function(c, u) {
			return zt(this, new m(c, u));
		}, n.decimalPlaces = n.dp = function(c, u) {
			var p, y, _, v = this;
			if (c != null) return $(c, 0, et), u == null ? u = o : $(u, 0, 8), G(new m(v), c + v.e + 1, u);
			if (!(p = v.c)) return null;
			if (y = ((_ = p.length - 1) - dt(this.e / j)) * j, _ = p[_]) for (; _ % 10 == 0; _ /= 10, y--);
			return y < 0 && (y = 0), y;
		}, n.dividedBy = n.div = function(c, u) {
			return e(this, new m(c, u), a, o);
		}, n.dividedToIntegerBy = n.idiv = function(c, u) {
			return e(this, new m(c, u), 0, 1);
		}, n.exponentiatedBy = n.pow = function(c, u) {
			var p, y, _, v, E, b, x, P, C, T = this;
			if (c = new m(c), c.c && !c.isInteger()) throw Error(ot + "Exponent not an integer: " + q(c));
			if (u != null && (u = new m(u)), b = c.e > 14, !T.c || !T.c[0] || T.c[0] == 1 && !T.e && T.c.length == 1 || !c.c || !c.c[0]) return C = new m(Math.pow(+q(T), b ? c.s * (2 - Ve(c)) : +q(c))), u ? C.mod(u) : C;
			if (x = c.s < 0, u) {
				if (u.c ? !u.c[0] : !u.s) return new m(NaN);
				y = !x && T.isInteger() && u.isInteger(), y && (T = T.mod(u));
			} else {
				if (c.e > 9 && (T.e > 0 || T.e < -1 || (T.e == 0 ? T.c[0] > 1 || b && T.c[1] >= 24e7 : T.c[0] < 8e13 || b && T.c[0] <= 9999975e7))) return v = T.s < 0 && Ve(c) ? -0 : 0, T.e > -1 && (v = 1 / v), new m(x ? 1 / v : v);
				S && (v = Ni(S / j + 2));
			}
			for (b ? (p = new m(.5), x && (c.s = 1), P = Ve(c)) : (_ = Math.abs(+q(c)), P = _ % 2), C = new m(s);;) {
				if (P) {
					if (C = C.times(T), !C.c) break;
					v ? C.c.length > v && (C.c.length = v) : y && (C = C.mod(u));
				}
				if (_) {
					if (_ = ft(_ / 2), _ === 0) break;
					P = _ % 2;
				} else if (c = c.times(p), G(c, c.e + 1, 1), c.e > 14) P = Ve(c);
				else {
					if (_ = +q(c), _ === 0) break;
					P = _ % 2;
				}
				T = T.times(T), v ? T.c && T.c.length > v && (T.c.length = v) : y && (T = T.mod(u));
			}
			return y ? C : (x && (C = s.div(C)), u ? C.mod(u) : v ? G(C, S, o, E) : C);
		}, n.integerValue = function(c) {
			var u = new m(this);
			return c == null ? c = o : $(c, 0, 8), G(u, u.e + 1, c);
		}, n.isEqualTo = n.eq = function(c, u) {
			return zt(this, new m(c, u)) === 0;
		}, n.isFinite = function() {
			return !!this.c;
		}, n.isGreaterThan = n.gt = function(c, u) {
			return zt(this, new m(c, u)) > 0;
		}, n.isGreaterThanOrEqualTo = n.gte = function(c, u) {
			return (u = zt(this, new m(c, u))) === 1 || u === 0;
		}, n.isInteger = function() {
			return !!this.c && dt(this.e / j) > this.c.length - 2;
		}, n.isLessThan = n.lt = function(c, u) {
			return zt(this, new m(c, u)) < 0;
		}, n.isLessThanOrEqualTo = n.lte = function(c, u) {
			return (u = zt(this, new m(c, u))) === -1 || u === 0;
		}, n.isNaN = function() {
			return !this.s;
		...
		}, n.minus = function(c, u) {
			var p, y, _, v, E = this, b = E.s;
			if (c = new m(c, u), u = c.s, !b || !u) return new m(NaN);
			if (b != u) return c.s = -u, E.plus(c);
			var x = E.e / j, P = c.e / j, C = E.c, T = c.c;
			if (!x || !P) {
				if (!C || !T) return C ? (c.s = -u, c) : new m(T ? E : NaN);
				if (!C[0] || !T[0]) return T[0] ? (c.s = -u, c) : new m(C[0] ? E : o == 3 ? -0 : 0);
			}
			if (x = dt(x), P = dt(P), C = C.slice(), b = x - P) {
				for ((v = b < 0) ? (b = -b, _ = C) : (P = x, _ = T), _.reverse(), u = b; u--; _.push(0));
				_.reverse();
			} else for (y = (v = (b = C.length) < (u = T.length)) ? b : u, b = u = 0; u < y; u++) if (C[u] != T[u]) {
				v = C[u] < T[u];
				break;
			}
			if (v && (_ = C, C = T, T = _, c.s = -c.s), u = (y = T.length) - (p = C.length), u > 0) for (; u--; C[p++] = 0);
			for (u = _t - 1; y > b;) {
				if (C[--y] < T[y]) {
					for (p = y; p && !C[--p]; C[p] = u);
					--C[p], C[y] += _t;
			...
			return C[0] ? I(c, C, P) : (c.s = o == 3 ? -1 : 1, c.c = [c.e = 0], c);
		}, n.modulo = n.mod = function(c, u) {
			var p, y, _ = this;
			return c = new m(c, u), !_.c || !c.s || c.c && !c.c[0] ? new m(NaN) : !c.c || _.c && !_.c[0] ? new m(_) : (w == 9 ? (y = c.s, c.s = 1, p = e(_, c, 0, 3), c.s = y, p.s *= y) : p = e(_, c, 0, w), c = _.minus(p.times(c)), !c.c[0] && w == 1 && (c.s = _.s), c);
		}, n.multipliedBy = n.times = function(c, u) {
			var p, y, _, v, E, b, x, P, C, T, N, z, K, Z, tt, U = this, H = U.c, it = (c = new m(c, u)).c;
			if (!H || !it || !H[0] || !it[0]) return !U.s || !c.s || H && !H[0] && !it || it && !it[0] && !H ? c.c = c.e = c.s = null : (c.s *= U.s, !H || !it ? c.c = c.e = null : (c.c = [0], c.e = 0)), c;
			for (y = dt(U.e / j) + dt(c.e / j), c.s *= U.s, x = H.length, T = it.length, x < T && (K = H, H = it, it = K, _ = x, x = T, T = _), _ = x + T, K = []; _--; K.push(0));
			for (Z = _t, tt = Rt, _ = T; --_ >= 0;) {
				for (p = 0, N = it[_] % tt, z = it[_] / tt | 0, E = x, v = _ + E; v > _;) P = H[--E] % tt, C = H[E] / tt | 0, b = z * P + C * N, P = N * P + b % tt * tt + K[v] + p, p = (P / Z | 0) + (b / tt | 0) + z * C, K[v--] = P % Z;
				K[v] = p;
			}
			return p ? ++y : K.splice(0, 1), I(c, K, y);
		}, n.negated = function() {
			var c = new m(this);
			return c.s = -c.s || null, c;
		}, n.plus = function(c, u) {
			var p, y = this, _ = y.s;
			if (c = new m(c, u), u = c.s, !_ || !u) return new m(NaN);
			if (_ != u) return c.s = -u, y.minus(c);
			var v = y.e / j, E = c.e / j, b = y.c, x = c.c;
			if (!v || !E) {
				if (!b || !x) return new m(_ / 0);
				if (!b[0] || !x[0]) return x[0] ? c : new m(b[0] ? y : _ * 0);
			}
			if (v = dt(v), E = dt(E), b = b.slice(), _ = v - E) {
				for (_ > 0 ? (E = v, p = x) : (_ = -_, p = b), p.reverse(); _--; p.push(0));
				p.reverse();
			}
			for (_ = b.length, u = x.length, _ - u < 0 && (p = x, x = b, b = p, u = _), _ = 0; u;) _ = (b[--u] = b[u] + x[u] + _) / _t | 0, b[u] = _t === b[u] ? 0 : b[u] % _t;
			return _ && (b = [_].concat(b), ++E), I(c, b, E);
		}, n.precision = n.sd = function(c, u) {
			var p, y, _, v = this;
			if (c != null && c !== !!c) return $(c, 1, et), u == null ? u = o : $(u, 0, 8), G(new m(v), c, u);
			if (!(p = v.c)) return null;
			if (_ = p.length - 1, y = _ * j + 1, _ = p[_]) {
				for (; _ % 10 == 0; _ /= 10, y--);
				for (_ = p[0]; _ >= 10; _ /= 10, y++);
			}
			return c && v.e + 1 > y && (y = v.e + 1), y;
		}, n.shiftedBy = function(c) {
			return $(c, -zi, zi), this.times("1e" + c);
		}, n.squareRoot = n.sqrt = function() {
			var c, u, p, y, _, v = this, E = v.c, b = v.s, x = v.e, P = a + 4, C = new m("0.5");
			if (b !== 1 || !E || !E[0]) return new m(!b || b < 0 && (!E || E[0]) ? NaN : E ? v : Infinity);
			if (b = Math.sqrt(+q(v)), b == 0 || b == Infinity ? (u = pt(E), (u.length + x) % 2 == 0 && (u += "0"), b = Math.sqrt(+u), x = dt((x + 1) / 2) - (x < 0 || x % 2), b == Infinity ? u = "5e" + x : (u = b.toExponential(), u = u.slice(0, u.indexOf("e") + 1) + x), p = new m(u)) : p = new m(b + ""), p.c[0]) {
				for (x = p.e, b = x + P, b < 3 && (b = 0);;) if (_ = p, p = C.times(_.plus(e(v, _, P, 1))), pt(_.c).slice(0, b) === (u = pt(p.c)).slice(0, b)) if (p.e < x && --b, u = u.slice(b - 3, b + 1), u == "9999" || !y && u == "4999") {
					if (!y && (G(_, _.e + a + 2, 0), _.times(_).eq(v))) {
						p = _;
						break;
					}
					P += 4, b += 4, y = 1;
				} else {
					(!+u || !+u.slice(1) && u.charAt(0) == "5") && (G(p, p.e + a + 2, 1), c = !p.times(p).eq(v));
					break;
				}
			}
			return G(p, p.e + a + 1, o, c);
		}, n.toExponential = function(c, u) {
			return c != null && ($(c, 0, et), c++), O(this, c, u, 1);
		}, n.toFixed = function(c, u) {
			return c != null && ($(c, 0, et), c = c + this.e + 1), O(this, c, u);
		}, n.toFormat = function(c, u, p) {
			var y, _ = this;
			if (p == null) c != null && u && typeof u == "object" ? (p = u, u = null) : c && typeof c == "object" ? (p = c, c = u = null) : p = A;
			else if (typeof p != "object") throw Error(ot + "Argument not an object: " + p);
			if (y = _.toFixed(c, u), _.c) {
				var v, E = y.split("."), b = +p.groupSize, x = +p.secondaryGroupSize, P = p.groupSeparator || "", C = E[0], T = E[1], N = _.s < 0, z = N ? C.slice(1) : C, K = z.length;
				if (x && (v = b, b = x, x = v, K -= v), b > 0 && K > 0) {
					for (v = K % b || b, C = z.substr(0, v); v < K; v += b) C += P + z.substr(v, b);
					x > 0 && (C += P + z.slice(v)), N && (C = "-" + C);
				}
				y = T ? C + (p.decimalSeparator || "") + ((x = +p.fractionGroupSize) ? T.replace(new RegExp("\\d{" + x + "}\\B", "g"), "$&" + (p.fractionGroupSeparator || "")) : T) : C;
			}
			return (p.prefix || "") + y + (p.suffix || "");
		}, n.toFraction = function(c) {
			var u, p, y, _, v, E, b, x, P, C, T, N, z = this, K = z.c;
			if (c != null && (b = new m(c), !b.isInteger() && (b.c || b.s !== 1) || b.lt(s))) throw Error(ot + "Argument " + (b.isInteger() ? "out of range: " : "not an integer: ") + q(b));
			if (!K) return new m(z);
			for (u = new m(s), P = p = new m(s), y = x = new m(s), N = pt(K), v = u.e = N.length - z.e - 1, u.c[0] = Fi[(E = v % j) < 0 ? j + E : E], c = !c || b.comparedTo(u) > 0 ? v > 0 ? u : P : b, E = f, f = Infinity, b = new m(N), x.c[0] = 0; C = e(b, u, 0, 1), _ = p.plus(C.times(y)), _.comparedTo(c) != 1;) p = y, y = _, P = x.plus(C.times(_ = P)), x = _, u = b.minus(C.times(_ = u)), b = _;
			return _ = e(c.minus(p), y, 0, 1), x = x.plus(_.times(P)), p = p.plus(_.times(y)), x.s = P.s = z.s, v = v * 2, T = e(P, y, v, o).minus(z).abs().comparedTo(e(x, p, v, o).minus(z).abs()) < 1 ? [P, y] : [x, p], f = E, T;
		}, n.toNumber = function() {
			return +q(this);
		}, n.toPrecision = function(c, u) {
			return c != null && $(c, 1, et), O(this, c, u, 2);
		}, n.toString = function(c) {
			var u, p = this, y = p.s, _ = p.e;
			return _ === null ? y ? (u = "Infinity", y < 0 && (u = "-" + u)) : u = "NaN" : (c == null ? u = _ <= h || _ >= l ? Ue(pt(p.c), _) : Mt(pt(p.c), _, "0") : c === 10 && M ? (p = G(new m(p), a + _ + 1, o), u = Mt(pt(p.c), p.e, "0")) : ($(c, 2, g.length, "Base"), u = i(Mt(pt(p.c), _, "0"), 10, c, y, !0)), y < 0 && p.c[0] && (u = "-" + u)), u;
		}, n.valueOf = n.toJSON = function() {
			return q(this);
		}, n._isBigNumber = !0, n[Symbol.toStringTag] = "BigNumber", n[Symbol.for("nodejs.util.inspect.custom")] = n.valueOf, t != null && m.set(t), m;
	}
	function dt(t) {
		var e = t | 0;
	...
	function pt(t) {
		for (var e, i, r = 1, n = t.length, s = t[0] + ""; r < n;) {
			for (e = t[r++] + "", i = j - e.length; i--; e = "0" + e);
			s += e;
		}
	...
	function zt(t, e) {
		var i, r, n = t.c, s = e.c, a = t.s, o = e.s, h = t.e, l = e.e;
		if (!a || !o) return null;
		if (i = n && !n[0], r = s && !s[0], i || r) return i ? r ? 0 : -o : a;
		if (a != o) return a;
		if (i = a < 0, r = h == l, !n || !s) return r ? 0 : !n ^ i ? 1 : -1;
		if (!r) return h > l ^ i ? 1 : -1;
		for (o = (h = n.length) < (l = s.length) ? h : l, a = 0; a < o; a++) if (n[a] != s[a]) return n[a] > s[a] ^ i ? 1 : -1;
		return h == l ? 0 : h > l ^ i ? 1 : -1;
	}
	function $(t, e, i, r) {
		if (t < e || t > i || t !== ft(t)) throw Error(ot + (r || "Argument") + (typeof t == "number" ? t < e || t > i ? " out of range: " : " not an integer: " : " not a primitive number: ") + String(t));
	}
	function Ve(t) {
		var e = t.c.length - 1;
		return dt(t.e / j) == e && t.c[e] % 2 != 0;
	}
	function Ue(t, e) {
	...
	var jm = class {
		...
		splay(t) {
			...
			let i = null, r = null, n = null, s = null, a = e, o = this.compare, h;
			for (;;) if (h = o(a.key, t), h > 0) {
				let l = a.left;
				if (l == null || (h = o(l.key, t), h > 0 && (a.left = l.right, l.right = a, a = l, l = a.left, l == null))) break;
				i == null ? r = a : i.left = a, i = a, a = l;
			} else if (h < 0) {
				let l = a.right;
				if (l == null || (h = o(l.key, t), h < 0 && (a.right = l.left, l.left = a, a = l, l = a.right, l == null))) break;
				n == null ? s = a : n.right = a, n = a, a = l;
			} else break;
			return n != null && (n.right = a.left, a.left = s), i != null && (i.left = a.right, a.right = r), this.root !== a && (this.root = a, this.splayCount++), h;
		}
		splayMin(t) {
			let e = t, i = e.left;
			for (; i != null;) {
	...
	var Ft = class xe extends jm {
		...
		add(e) {
			let i = this.splay(e);
			return i != 0 && this.addNewRoot(new ve(e), i), this;
		}
		addAndReturn(e) {
			let i = this.splay(e);
			return i != 0 && this.addNewRoot(new ve(e), i), this.root.key;
		}
		addAll(e) {
		...
		retainAll(e) {
			let i = new xe(this.compare, this.validKey), r = this.modificationCount;
			for (let n of e) {
	...
	var dl = (t) => () => t, ji = (t) => {
		let e = t ? (i, r) => r.minus(i).abs().isLessThanOrEqualTo(t) : dl(!1);
		return (i, r) => e(i, r) ? 0 : i.comparedTo(r);
	};
	function Km(t) {
		let e = t ? (i, r, n, s, a) => i.exponentiatedBy(2).isLessThanOrEqualTo(s.minus(r).exponentiatedBy(2).plus(a.minus(n).exponentiatedBy(2)).times(t)) : dl(!1);
		return (i, r, n) => {
			let s = i.x, a = i.y, o = n.x, h = n.y, l = a.minus(h).times(r.x.minus(o)).minus(s.minus(o).times(r.y.minus(h)));
			return e(l, s, a, o, h) ? 0 : l.comparedTo(0);
		};
	}
	var Hm = (t) => t, Xm = (t) => {
		if (t) {
			let e = new Ft(ji(t)), i = new Ft(ji(t)), r = (s, a) => a.addAndReturn(s), n = (s) => ({
				x: r(s.x, e),
				y: r(s.y, i)
			});
			return n({
		...
		snap: Xm(t),
		orient: Km(t)
	}), vt = Vi(), we = (t, e) => t.ll.x.isLessThanOrEqualTo(e.x) && e.x.isLessThanOrEqualTo(t.ur.x) && t.ll.y.isLessThanOrEqualTo(e.y) && e.y.isLessThanOrEqualTo(t.ur.y), Ui = (t, e) => {
	...
	}, Ke = (t, e) => t.x.times(e.y).minus(t.y.times(e.x)), gl = (t, e) => t.x.times(e.x).plus(t.y.times(e.y)), Xe = (t) => gl(t, t).sqrt(), Ym = (t, e, i) => {
		let r = {
			x: e.x.minus(t.x),
			y: e.y.minus(t.y)
		}, n = {
		...
		return Ke(n, r).div(Xe(n)).div(Xe(r));
	}, Jm = (t, e, i) => {
		let r = {
			x: e.x.minus(t.x),
			y: e.y.minus(t.y)
		...
		return gl(n, r).div(Xe(n)).div(Xe(r));
	}, hl = (t, e, i) => e.y.isZero() ? null : {
		x: t.x.plus(e.x.div(e.y).times(i.minus(t.y))),
		y: i
	}, cl = (t, e, i) => e.x.isZero() ? null : {
		x: i,
		y: t.y.plus(e.y.div(e.x).times(i.minus(t.x)))
	}, $m = (t, e, i, r) => {
		if (e.x.isZero()) return cl(i, r, t.x);
		if (r.x.isZero()) return cl(t, e, i.x);
		if (e.y.isZero()) return hl(i, r, t.y);
		if (r.y.isZero()) return hl(t, e, i.y);
		let n = Ke(e, r);
		if (n.isZero()) return null;
		let s = {
			x: i.x.minus(t.x),
			y: i.y.minus(t.y)
		}, a = Ke(s, e).div(n), o = Ke(s, r).div(n), h = t.x.plus(o.times(e.x)), l = i.x.plus(a.times(r.x)), d = t.y.plus(o.times(e.y)), f = i.y.plus(a.times(r.y));
		return {
			x: h.plus(l).div(2),
			y: d.plus(f).div(2)
		};
		...
		static compare(e, i) {
			...
			return r !== 0 ? r : (e.point !== i.point && e.link(i), e.isLeft !== i.isLeft ? e.isLeft ? 1 : -1 : Je.compare(e.segment, i.segment));
		}
		...
		getLeftmostComparator(e) {
			let i = /* @__PURE__ */ new Map(), r = (n) => {
				let s = n.otherSE;
				i.set(n, {
					sine: Ym(this.point, e.point, s.point),
					cosine: Jm(this.point, e.point, s.point)
				});
			};
			return (n, s) => {
				i.has(n) || r(n), i.has(s) || r(s);
				let { sine: a, cosine: o } = i.get(n), { sine: h, cosine: l } = i.get(s);
				return a.isGreaterThanOrEqualTo(0) && h.isGreaterThanOrEqualTo(0) ? o.isLessThan(l) ? 1 : o.isGreaterThan(l) ? -1 : 0 : a.isLessThan(0) && h.isLessThan(0) ? o.isLessThan(l) ? -1 : o.isGreaterThan(l) ? 1 : 0 : h.isLessThan(a) ? -1 : h.isGreaterThan(a) ? 1 : 0;
			};
		}
	}, Zm = class Ki {
		events;
		...
		static factory(e) {
			...
			for (let r = 0, n = e.length; r < n; r++) {
				...
				let a = null, o = s.leftSE, h = s.rightSE, l = [o], d = o.point, f = [];
				for (; a = o, o = h, l.push(o), o.point !== d;) for (;;) {
					let k = o.getAvailableLinkedEvents();
					if (k.length === 0) {
					...
					let w = null;
					for (let A = 0, g = f.length; A < g; A++) if (f[A].point === o.point) {
						w = A;
						break;
					}
					if (w !== null) {
						let A = f.splice(w)[0], g = l.splice(A.index);
						g.unshift(g[0].otherSE), i.push(new Ki(g.reverse()));
						continue;
					}
					f.push({
						index: l.length,
					...
					let S = o.getLeftmostComparator(a);
					h = k.sort(S)[0].otherSE;
					break;
				}
				i.push(new Ki(l));
			}
		...
		getGeom() {
			...
			let s = this.isExteriorRing() ? 1 : -1, a = this.isExteriorRing() ? 0 : i.length - 1, o = this.isExteriorRing() ? i.length : -1, h = [];
			for (let l = a; l != o; l += s) h.push([i[l].x.toNumber(), i[l].y.toNumber()]);
			return h;
		}
		isExteriorRing() {
		...
		_composePolys(t) {
			...
			for (let i = 0, r = t.length; i < r; i++) {
				let n = t[i];
				if (!n.poly) if (n.isExteriorRing()) e.push(new ul(n));
				else {
					let s = n.enclosingRing();
					s?.poly || e.push(new ul(s)), s?.poly?.addInterior(n);
				}
			}
			return e;
		}
			...
			if (t.isLeft) {
				...
				if (r) {
					...
					if (o !== null && (e.isAnEndpoint(o) || (s = o), !r.isAnEndpoint(o))) {
						let h = this._splitSafely(r, o);
						for (let l = 0, d = h.length; l < d; l++) i.push(h[l]);
					}
				}
				let a = null;
				if (n) {
					let o = n.getIntersection(e);
					if (o !== null && (e.isAnEndpoint(o) || (a = o), !n.isAnEndpoint(o))) {
						let h = this._splitSafely(n, o);
						for (let l = 0, d = h.length; l < d; l++) i.push(h[l]);
					}
				}
				if (s !== null || a !== null) {
					let o = null;
					s === null ? o = a : a === null ? o = s : o = kt.comparePoints(s, a) <= 0 ? s : a, this.queue.delete(e.rightSE), i.push(e.rightSE);
					let h = e.split(o);
					for (let l = 0, d = h.length; l < d; l++) i.push(h[l]);
				}
				...
				if (r && n) {
					...
					if (s !== null) {
						if (!r.isAnEndpoint(s)) {
							...
							for (let o = 0, h = a.length; o < h; o++) i.push(a[o]);
						}
						if (!n.isAnEndpoint(s)) {
		...
		run(t, e, i) {
			Ce.type = t;
			let r = [new fl(e, !0)];
			for (let l = 0, d = i.length; l < d; l++) r.push(new fl(i[l], !1));
			if (Ce.numMultiPolys = r.length, Ce.type === "difference") {
				let l = r[0], d = 1;
				for (; d < r.length;) Ui(r[d].bbox, l.bbox) !== null ? d++ : r.splice(d, 1);
			}
			if (Ce.type === "intersection") for (let l = 0, d = r.length; l < d; l++) {
				let f = r[l];
				for (let k = l + 1, w = r.length; k < w; k++) if (Ui(f.bbox, r[k].bbox) === null) return [];
			}
			let n = new Ft(kt.compare);
			for (let l = 0, d = r.length; l < d; l++) {
				let f = r[l].getSweepEvents();
				for (let k = 0, w = f.length; k < w; k++) n.add(f[k]);
			}
			let s = new Qm(n), a = null;
			...
			vt.reset();
			return new Wm(Zm.factory(s.segments)).getGeom();
		}
	}, Ce = new t_(), Ye = Ce, e_ = 0, Je = class He {
		id;
		leftSE;
		rightSE;
		rings;
		...
		static compare(e, i) {
			...
			let o = e.leftSE.point.y, h = i.leftSE.point.y, l = e.rightSE.point.y, d = i.rightSE.point.y;
			if (r.isLessThan(n)) {
				if (h.isLessThan(o) && h.isLessThan(l)) return 1;
				if (h.isGreaterThan(o) && h.isGreaterThan(l)) return -1;
			...
			if (r.isGreaterThan(n)) {
				if (o.isLessThan(h) && o.isLessThan(d)) return -1;
				if (o.isGreaterThan(h) && o.isGreaterThan(d)) return 1;
				let f = i.comparePoint(e.leftSE.point);
				if (f !== 0) return f;
				let k = e.comparePoint(i.rightSE.point);
				return k < 0 ? 1 : k > 0 ? -1 : 1;
			}
			if (o.isLessThan(h)) return -1;
			if (o.isGreaterThan(h)) return 1;
			if (s.isLessThan(a)) {
			...
			if (!s.eq(a)) {
				let f = l.minus(o), k = s.minus(r), w = d.minus(h), S = a.minus(n);
				if (f.isGreaterThan(k) && w.isLessThan(S)) return 1;
				if (f.isLessThan(k) && w.isGreaterThan(S)) return -1;
			}
			return s.isGreaterThan(a) ? 1 : s.isLessThan(a) || l.isLessThan(d) ? -1 : l.isGreaterThan(d) ? 1 : e.id < i.id ? -1 : e.id > i.id ? 1 : 0;
		}
		constructor(e, i, r, n) {
			this.id = ++e_, this.leftSE = e, e.segment = this, e.otherSE = i, this.rightSE = i, i.segment = this, i.otherSE = e, this.rings = r, this.windings = n;
		}
		static fromRing(e, i, r) {
			let n, s, a, o = kt.comparePoints(e, i);
			if (o < 0) n = e, s = i, a = 1;
			else if (o > 0) n = i, s = e, a = -1;
			else throw new Error(`Tried to create degenerate segment at [${e.x}, ${e.y}]`);
			return new He(new kt(n, !0), new kt(s, !1), [r], [a]);
		}
		replaceRightSE(e) {
		...
		getIntersection(e) {
			let i = this.bbox(), r = e.bbox(), n = Ui(i, r);
			if (n === null) return null;
			let s = this.leftSE.point, a = this.rightSE.point, o = e.leftSE.point, h = e.rightSE.point, l = we(i, o) && this.comparePoint(o) === 0, d = we(r, s) && e.comparePoint(s) === 0, f = we(i, h) && this.comparePoint(h) === 0, k = we(r, a) && e.comparePoint(a) === 0;
			if (d && l) return k && !f ? a : !k && f ? h : null;
			if (d) return f && s.x.eq(h.x) && s.y.eq(h.y) ? null : s;
			if (l) return k && a.x.eq(o.x) && a.y.eq(o.y) ? null : o;
			if (k && f) return null;
			if (k) return a;
			if (f) return h;
			let w = $m(s, this.vector(), o, e.vector());
			return w === null || !we(n, w) ? null : vt.snap(w);
		}
		split(e) {
			let i = [], r = e.events !== void 0, n = new kt(e, !0), s = new kt(e, !1), a = this.rightSE;
			this.replaceRightSE(s), i.push(s), i.push(n);
			let o = new He(n, a, this.rings.slice(), this.windings.slice());
			return kt.comparePoints(o.leftSE.point, o.rightSE.point) > 0 && o.swapEvents(), kt.comparePoints(this.leftSE.point, this.rightSE.point) > 0 && this.swapEvents(), r && (n.checkForConsuming(), s.checkForConsuming()), i;
		}
		swapEvents() {
			let e = this.rightSE;
		...
		consume(e) {
			...
			if (n !== 0) {
				...
				for (let s = 0, a = r.rings.length; s < a; s++) {
					let o = r.rings[s], h = r.windings[s], l = i.rings.indexOf(o);
					l === -1 ? (i.rings.push(o), i.windings.push(h)) : i.windings[l] += h;
				}
		...
		afterState() {
			...
			for (let o = 0, h = this.rings.length; o < h; o++) {
				let l = this.rings[o], d = this.windings[o], f = i.indexOf(l);
			...
			for (let o = 0, h = i.length; o < h; o++) {
				if (r[o] === 0) continue;
				let l = i[o], d = l.poly;
				if (a.indexOf(d) === -1) if (l.isExterior) s.push(d);
				else {
		...
		isInResult() {
			...
			switch (Ye.type) {
				case "union":
					this._isInResult = e.length === 0 !== (i.length === 0);
					break;
				case "intersection": {
					let r, n;
					e.length < i.length ? (r = e.length, n = i.length) : (r = i.length, n = e.length), this._isInResult = n === Ye.numMultiPolys && r < n;
					break;
				}
				case "xor":
					this._isInResult = Math.abs(e.length - i.length) % 2 === 1;
					break;
				case "difference": {
		...
		constructor(t, e, i) {
			...
			for (let s = 1, a = t.length; s < a; s++) {
				...
				o.x.eq(n.x) && o.y.eq(n.y) || (this.segments.push(Je.fromRing(n, o, this)), o.x.isLessThan(this.bbox.ll.x) && (this.bbox.ll.x = o.x), o.y.isLessThan(this.bbox.ll.y) && (this.bbox.ll.y = o.y), o.x.isGreaterThan(this.bbox.ur.x) && (this.bbox.ur.x = o.x), o.y.isGreaterThan(this.bbox.ur.y) && (this.bbox.ur.y = o.y), n = o);
			}
			(!r.x.eq(n.x) || !r.y.eq(n.y)) && this.segments.push(Je.fromRing(n, r, this));
		}
		getSweepEvents() {
			let t = [];
		...
		constructor(t, e) {
			...
			this.exteriorRing = new pl(t[0], this, !0), this.bbox = {
				ll: {
		...
		constructor(t, e) {
			...
			this.polys = [], this.bbox = {
				ll: {
					x: new gt(Number.POSITIVE_INFINITY),
					y: new gt(Number.POSITIVE_INFINITY)
				},
				ur: {
					x: new gt(Number.NEGATIVE_INFINITY),
					y: new gt(Number.NEGATIVE_INFINITY)
				}
			};
			for (let i = 0, r = t.length; i < r; i++) {
				let n = new i_(t[i], this);
	...
	var _l = (t, ...e) => Ye.run("intersection", t, e), yl = (t, ...e) => Ye.run("difference", t, e);
	vt.set;
	function Ze(t) {
		let e = { type: "Feature" };
	...
	function Ml(t, e) {
		let i = $e(t), r = $e(e), n = _l(i.coordinates, r.coordinates);
		return n.length === 0 ? null : n.length === 1 ? bl(n[0]) : kl(n);
	}
	function vl(t, e) {
		let i = $e(t), r = $e(e), n = yl(i.coordinates, r.coordinates);
		return n.length === 0 ? null : n.length === 1 ? bl(n[0]) : kl(n);
	}
	function xl(t) {
		return Array.isArray(t) ? 1 + xl(t[0]) : -1;
	}
	function wl(t) {
	...
	function Cl(t) {
		...
		return t.eachLayer((i) => {
			e.push(Ll(i.toGeoJSON(15)));
		}), s_(e);
	}
	Y.Cut = Y.Polygon.extend({
		initialize(t) {
		...
		cut(t) {
			...
			Object.keys(e).map((n) => e[n]).filter((n) => n.pm).filter((n) => !n._pmTempLayer).filter((n) => !L.PM.optIn && !n.options.pmIgnore || L.PM.optIn && n.options.pmIgnore === !1).filter((n) => n instanceof L.Polyline).filter((n) => n !== t).filter((n) => n.pm.options.allowCutting).filter((n) => this.options.layersToCut && L.Util.isArray(this.options.layersToCut) && this.options.layersToCut.length > 0 ? this.options.layersToCut.indexOf(n) > -1 : !0).filter((n) => !this._layerGroup.hasLayer(n)).filter((n) => {
						...
						if (d && d.snapInfo) {
							...
							if (k && k.segment && k.distance < this.options.snapDistance) {
								...
								if (w && w.length === 2) {
									...
									(S.length > 1 ? (0, El.default)(l, A) : l).splice(g, 0, f);
								}
							}
						}
					});
				...
				let h = o.addTo(this._map.pm._getContainingLayer());
				if (h.pm.enable(n.pm.options), h.pm.disable(), n._pmTempLayer = !0, t._pmTempLayer = !0, n.remove(), n.removeFrom(this._map.pm._getContainingLayer()), t.remove(), t.removeFrom(this._map.pm._getContainingLayer()), h.getLayers && h.getLayers().length === 0 && this._map.pm.removeLayer({ target: h }), h instanceof L.LayerGroup ? (h.eachLayer((l) => {
					this._addDrawnLayerProp(l);
				}), this._addDrawnLayerProp(h)) : this._addDrawnLayerProp(h), this.options.layersToCut && L.Util.isArray(this.options.layersToCut) && this.options.layersToCut.length > 0) {
		...
		_cutLayer(t, e) {
			let i = L.geoJSON(), r;
			if (e instanceof L.Polygon) r = vl(e.toGeoJSON(15), t.toGeoJSON(15));
			else {
				let n = wl(e);
				n.forEach((s) => {
					let a = Wo(s, t.toGeoJSON(15)), o;
					a && a.features.length > 0 ? o = L.geoJSON(a) : o = L.geoJSON(s), o.getLayers().forEach((h) => {
						sl(t.toGeoJSON(15), h.toGeoJSON(15)) || h.addTo(i);
					});
				}), n.length > 1 ? r = Cl(i) : r = i.toGeoJSON(15);
			}
			return r;
		},
	...
	Y.Text = Y.extend({
		...
		enable(t) {
			L.Util.setOptions(this, t), this._enabled = !0, this._map.on("click", this._createMarker, this), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !0), this._hintMarker = L.marker(this._map.getCenter(), {
				...
				zIndexOffset: 100,
				icon: L.divIcon({ className: "marker-icon cursor-marker" })
			}), this._setPane(this._hintMarker, "vertexPane"), this._hintMarker._pmTempLayer = !0, this._hintMarker.addTo(this._map), this.options.cursorMarker && L.DomUtil.addClass(this._hintMarker._icon, "visible"), this.options.tooltips && this._hintMarker.bindTooltip(F("tooltips.placeText"), {
				permanent: !0,
				offset: L.point(0, 10),
				direction: "bottom",
				opacity: .8
		...
		_createMarker(t) {
			...
			let i = this._createTextIcon(this.textArea), r = new L.Marker(e, {
				textMarker: !0,
				_textMarkerOverPM: !0,
				icon: i
			});
			if (this._setPane(r, "markerPane"), this._finishLayer(r), r.pm || (r.options.draggable = !1), r.addTo(this._map.pm._getContainingLayer()), r.pm) {
				r.pm.textArea = this.textArea, L.setOptions(r.pm, { removeIfEmpty: this.options.textOptions?.removeIfEmpty ?? !0 });
	...
	var Pl = {
		...
		disableLayerDrag() {
			this._layerDragEnabled = !1, St(this._layer) instanceof L.Canvas ? (this._layer.off("mouseout", this.removeDraggingClass, this), this._layer.off("mouseover", this.addDraggingClass, this)) : this.removeDraggingClass(), this._originalMapDragState && this._dragging && this._map.dragging.enable(), this._safeToCacheDragState = !1, this._layer.dragging && this._layer.dragging.disable();
			let t = this._getDOMElem();
			t && (St(this._layer) instanceof L.Canvas ? (this._layer.off("touchstart mousedown", this._dragMixinOnMouseDown, this), this._map.pm._removeTouchEvents(t)) : L.DomEvent.off(t, "touchstart mousedown", this._simulateMouseDownEvent, this)), this._layerDragged && this._fireUpdate(), this._layerDragged = !1, this._fireDragDisable();
		},
		dragging() {
		...
		_simulateMouseDownEvent(t) {
			let e = t.touches ? t.touches[0] : t, i = {
				originalEvent: e,
				target: this._layer
			};
	...
	function Hi(t, e, i) {
		let r = i.getMaxZoom();
		if (r === Infinity && (r = i.getZoom()), L.Util.isArray(t)) {
			let n = [];
			return t.forEach((s) => {
				n.push(Hi(s, e, i));
			}), n;
		}
		return t instanceof L.LatLng ? o_(t, e, i, r) : null;
	}
	function Ot(t, e) {
	...
	var X = L.Class.extend({
		includes: [
			Pl,
			Ae,
			{
				_onRotateStart(t) {
					this._preventRenderingMarkers(!0), this._rotationOriginLatLng = this._getRotationCenter().clone(), this._rotationOriginPoint = Ot(this._map, this._rotationOriginLatLng), this._rotationStartPoint = Ot(this._map, t.target.getLatLng()), this._initialRotateLatLng = Lt(this._layer), this._startAngle = this.getAngle();
				...
				_onRotate(t) {
					...
					let s = this;
					function a(d, f = [], k = -1) {
						if (k > -1 && f.push(k), L.Util.isArray(d[0])) d.forEach((w, S) => a(w, f.slice(), S));
						else {
							let w = f.length > 0 ? (0, Sl.default)(s._markers, f) : s._markers[0];
							d.forEach((S, A) => {
								w[A].setLatLng(S);
							});
						}
					...
					let h = n * 180 / Math.PI;
					h = h < 0 ? h + 360 : h;
					let l = h + this._startAngle;
					this._setAngle(l), this._rotationLayer.pm._setAngle(l), this._fireRotation(this._rotationLayer, h, o), this._fireRotation(this._map, h, o), this._rotationLayer.pm._fireChange(this._rotationLayer.getLatLngs(), "Rotation");
				},
				_onRotateEnd() {
					...
					let e = Lt(this._rotationLayer, this._rotationLayer.pm._rotateOrgLatLng);
					this._rotationLayer.pm._rotateOrgLatLng = Lt(this._rotationLayer), this._fireRotationEnd(this._rotationLayer, t, e), this._fireRotationEnd(this._map, t, e), this._rotationLayer.pm._fireEdit(this._rotationLayer, "Rotation"), this._preventRenderingMarkers(!1), this._layerRotated = !0;
				},
				_rotateLayer(t, e, i, r, n) {
					let s = Ot(n, i);
					return this._matrix = r.clone().rotate(t, s).flip(), Hi(e, this._matrix, n);
				},
				_setAngle(t) {
				...
				_getRotationCenter() {
					...
					let t = L.polygon(this._layer.getLatLngs(), {
						...
						fill: !1,
						pmIgnore: !0
					}).addTo(this._layer._map), e = t.getCenter();
				...
				enableRotate() {
					...
					this._rotatePoly = L.polygon(this._layer.getLatLngs(), {
						...
						pmIgnore: !1,
						snapIgnore: !0
					}), this._rotatePoly._pmTempLayer = !0, this._rotatePoly.addTo(this._layer._map), this._rotatePoly.pm._setAngle(this.getAngle()), this._rotatePoly.pm.setRotationCenter(this.getRotationCenter()), this._rotatePoly.pm.setOptions(this._layer._map.pm.getGlobalOptions()), this._rotatePoly.pm.setOptions({
						rotate: !0,
						snappable: !1,
						hideMiddleMarkers: !0
					}), this._rotatePoly.pm._rotationLayer = this._layer, this._rotatePoly.pm.enable(), this._rotateOrgLatLng = Lt(this._layer), this._rotateEnabled = !0, this._layer.on("remove", this.disableRotate, this), this._fireRotationEnable(this._layer), this._fireRotationEnable(this._layer._map);
				},
				disableRotate() {
	...
	X.Line = X.extend({
		includes: [{
			...
			createCache() {
				this.markerCache = [...this._markerGroup.getLayers(), ...this.markerCache].filter((e, i, r) => r.indexOf(e) === i);
			},
			_removeFromCache(t) {
			...
			_filterClosestMarkers(t) {
				...
				return i === -1 ? e : (e.sort((n, s) => {
					return n._latlng.distanceTo(t) - s._latlng.distanceTo(t);
		...
		_initMarkers() {
			...
			this._markerGroup && (this._markerGroup.removeFrom(t), this._markerGroup.clearLayers()), this._markerGroup = new L.FeatureGroup(), this._markerGroup._pmTempLayer = !0;
			let i = (r) => {
		...
		_handleLayerStyle(t) {
			...
			if (this.options.allowSelfIntersection ? i = !1 : (r = Wt(this._layer.toGeoJSON(15)), i = r.features.length > 0), i) {
				...
				t ? this._flashLayer() : (e.setStyle({ color: "#f00000ff" }), this.isRed = !0), this._fireIntersect(r);
		...
		_removeMarker(t) {
			...
			if (!r) return;
			let a = r.length > 1 ? (0, xt.default)(i, s) : i, o = r.length > 1 ? (0, xt.default)(this._markers, s) : this._markers, h = s[s.length - 1] > 0 && this._layer instanceof L.Polygon;
			if (!this.options.removeLayerBelowMinVertexCount && !h && (a.length <= 2 || this.isPolygon() && a.length <= 3)) {
				this._flashLayer();
				return;
			}
			a.splice(n, 1), this._layer.setLatLngs(i), this.isPolygon() && a.length <= 2 && a.splice(0, a.length);
			let l = !1;
			if (a.length <= 1 && (a.splice(0, a.length), s.length > 1 && r.length > 1 && (i = _e(i)), this._layer.setLatLngs(i), this._initMarkers(), l = !0), me(i) || this._layer.remove(), i = _e(i), this._layer.setLatLngs(i), this._markers = _e(this._markers), !l && (o = r.length > 1 ? (0, xt.default)(this._markers, s) : this._markers, e._middleMarkerPrev && (this._markerGroup.removeLayer(e._middleMarkerPrev), this._removeFromCache(e._middleMarkerPrev)), e._middleMarkerNext && (this._markerGroup.removeLayer(e._middleMarkerNext), this._removeFromCache(e._middleMarkerNext)), this._markerGroup.removeLayer(e), this._removeFromCache(e), o)) {
				let d, f;
				if (this.isPolygon() ? (d = (n + 1) % o.length, f = (n + (o.length - 1)) % o.length) : (f = n - 1 < 0 ? void 0 : n - 1, d = n + 1 >= o.length ? void 0 : n + 1), d !== f) {
					let k = o[f], w = o[d];
					this.options.hideMiddleMarkers !== !0 && this._createMiddleMarker(k, w);
				}
				o.splice(n, 1);
			}
		...
		updatePolygonCoordsFromMarkerDrag(t) {
			let e = this._layer.getLatLngs(), i = t.getLatLng(), { indexPath: r, index: n, parentPath: s } = L.PM.Utils.findDeepMarkerIndex(this._markers, t), a = r.length > 1 ? (0, xt.default)(e, s) : e;
			i.alt = a[n].alt, a.splice(n, 1, i), this._layer.setLatLngs(e);
		},
		_getNeighborMarkers(t) {
			let { indexPath: e, index: i, parentPath: r } = L.PM.Utils.findDeepMarkerIndex(this._markers, t), n = e.length > 1 ? (0, xt.default)(this._markers, r) : this._markers, s = (i + 1) % n.length;
			return {
				prevMarker: n[(i + (n.length - 1)) % n.length],
				nextMarker: n[s]
			};
		},
		_checkMarkerAllowedToDrag(t) {
			let { prevMarker: e, nextMarker: i } = this._getNeighborMarkers(t), r = L.polyline([e.getLatLng(), t.getLatLng()]), n = L.polyline([t.getLatLng(), i.getLatLng()]), a = Dt(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features.filter((l) => {
				let d = l.geometry.coordinates, f = L.latLng(d[1], d[0]);
				return !f.equals(e.getLatLng()) && !f.equals(t.getLatLng());
			}).length, h = Dt(this._layer.toGeoJSON(15), n.toGeoJSON(15)).features.filter((l) => {
				let d = l.geometry.coordinates, f = L.latLng(d[1], d[0]);
		...
		_onMarkerDragStart(t) {
			let e = t.target;
			if (this._preventRenderingMarkers(!0), this.cachedColor || (this.cachedColor = this._layer.options.color), !this._vertexValidation("move", t)) return;
		...
		_onMarkerDrag(t) {
			...
			let s = i.length > 1 ? (0, xt.default)(this._markers, n) : this._markers, a = (r + 1) % s.length, o = (r + (s.length - 1)) % s.length, h = e.getLatLng(), l = s[o].getLatLng(), d = s[a].getLatLng();
			if (e._middleMarkerNext) {
				let f = L.PM.Utils.calcMiddleLatLng(this._map, h, d);
				e._middleMarkerNext.setLatLng(f);
			}
			if (e._middleMarkerPrev) {
				let f = L.PM.Utils.calcMiddleLatLng(this._map, h, l);
	...
	X.Rectangle = X.Polygon.extend({
		...
		_onMarkerDragStart(t) {
			...
			let e = t.target;
			e._oppositeCornerLatLng = this._cornerMarkers.find((n) => n._index === (e._index + 2) % 4).getLatLng(), e._snapped = !1;
	...
	X.CircleMarker = X.extend({
		...
		_initMarkers() {
			let t = this._map;
			this._helperLayers && (this._helperLayers.removeFrom(t), this._helperLayers.clearLayers()), this._helperLayers = new L.FeatureGroup(), this._helperLayers._pmTempLayer = !0, this._helperLayers.addTo(t);
		...
		_getNewDestinationOfOuterMarker() {
			let t = this._centerMarker.getLatLng(), e = this._outerMarker.getLatLng(), i = this._distanceCalculation(t, e);
			return this.options[this._minRadiusOption] && i < this.options[this._minRadiusOption] ? e = Zt(this._map, t, e, this._getMinDistanceInMeter(t)) : this.options[this._maxRadiusOption] && i > this.options[this._maxRadiusOption] && (e = Zt(this._map, t, e, this._getMaxDistanceInMeter(t))), e;
		},
		_handleOuterMarkerSnapping() {
	...
	X.Circle = X.CircleMarker.extend({
		_shape: "Circle",
		initialize(t) {
			this._layer = t, this._enabled = !1, this._minRadiusOption = "minRadiusCircle", this._maxRadiusOption = "maxRadiusCircle", this._editableOption = "resizeableCircle", this._updateHiddenPolyCircle();
		},
		enable(t) {
	...
	Xi.init = () => new L.PM.Matrix(1, 0, 0, 1, 0, 0);
	Xi.prototype = {
		transform(t) {
		...
		_add(t, e, i, r, n, s) {
			...
			t && t instanceof L.PM.Matrix && (o = t._matrix, l = [
				[
					o[0],
					o[2],
					o[4]
			...
			for (let f = 0; f < 3; f += 1) for (let k = 0; k < 3; k += 1) {
				d = 0;
				for (let w = 0; w < 3; w += 1) d += h[f][w] * l[w][k];
				a[f][k] = d;
			}
			return this._matrix = [
				a[0][0],
	...
	var Rl = {
		...
		circleToPolygon(t, e = 60, i = !0) {
			let s = bi(t.getLatLng(), t.getRadius(), e, 0, i), a = [];
			for (let o = 0; o < s.length; o += 1) {
				let h = [s[o].lat, s[o].lng];
				a.push(h);
			}
		...
		getAllParentGroups(t) {
			...
			return !t._pmLastGroupFetch || !t._pmLastGroupFetch.time || (/* @__PURE__ */ new Date()).getTime() - t._pmLastGroupFetch.time > 1e3 ? (r(t), t._pmLastGroupFetch = {
		...
		createGeodesicPolygon: bi,
		getTranslation: F,
		findDeepCoordIndex(t, e, i = !0) {
			let r, n = (a) => (o, h) => {
				let l = a.concat(h);
				if (i) {
					if (o.lat && o.lat === e.lat && o.lng === e.lng) return r = l, !0;
				} else if (o.lat && L.latLng(o).equals(e)) return r = l, !0;
				return Array.isArray(o) && o.some(n(l));
			};
			t.some(n([]));
			let s = {};
			return r && (s = {
		...
		findDeepMarkerIndex(t, e) {
			let i, r = (s) => (a, o) => {
				let h = s.concat(o);
				return a._leaflet_id === e._leaflet_id ? (i = h, !0) : Array.isArray(a) && a.some(r(h));
			};
			t.some(r([]));
			let n = {};
			return i && (n = {
		...
		_getRotatedRectangle(t, e, i, r) {
			let n = Ot(r, t), s = Ot(r, e), a = i * Math.PI / 180, o = Math.cos(a), h = Math.sin(a), l = (s.x - n.x) * o + (s.y - n.y) * h, d = (s.y - n.y) * o - (s.x - n.x) * h, f = l * o + n.x, k = l * h + n.y, w = -d * h + n.x, S = d * o + n.y;
			return [
				Ee(r, n),
				Ee(r, {
					x: f,
